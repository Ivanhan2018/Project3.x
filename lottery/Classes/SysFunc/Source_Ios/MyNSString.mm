...
string MyNSString::ws2s(const wstring& ws)
{
...
wstring MyNSString::s2ws(const string& s)
{
	setlocale(LC_ALL, "chs"); 
...
void MyNSString::turnToImageView()
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_IOS) 
...
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
	JniMethodInfo t;
	if(JniHelper::getStaticMethodInfo(t,CLASS_NAME,"getNetworkType","()I"))
	{
		jint _int;
		_int = t.env->CallStaticIntMethod(t.classID, t.methodID);
		return _int;
	}
	return -1;
#endif

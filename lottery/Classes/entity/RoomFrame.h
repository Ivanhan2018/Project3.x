...
public:
	...
	//	用户状态——百家乐
	bool dealBJLOnSocketSubStatus(CMD_Command* pCommand, void * pBuffer, WORD wDataSize);
	//	用户状态——斗地主
	bool dealDDZOnSocketSubStatus(CMD_Command* pCommand, void * pBuffer, WORD wDataSize);

	//用户状态——捕鱼
	bool dealFishOnSocketSubStatus(CMD_Command* pCommand, void * pBuffer, WORD wDataSize);

	//	用户状态——碰碰车
	bool dealPPCOnSocketSubStatus(CMD_Command* pCommand, void * pBuffer, WORD wDataSize);

	//	用户状态——百人牛牛
	bool dealBRNNOnSocketSubStatus(CMD_Command* pCommand, void * pBuffer, WORD wDataSize);
...
public:
	...
	tagUserData* getMeUserDate() { return &(m_pMeUserItem->m_UserData); }
public:
...
protected:
	UsrDateMap m_UserDateList;	//	用户列表

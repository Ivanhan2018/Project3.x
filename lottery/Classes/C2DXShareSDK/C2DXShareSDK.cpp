...
void C2DXShareSDK::open(String *appKey, bool useAppTrusteeship)
{
...
void C2DXShareSDK::showShareMenu(Array *platTypes, Dictionary *content, Vec2 pt, C2DXMenuArrowDirection direction, C2DXShareResultEvent callback)
{
#if CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID

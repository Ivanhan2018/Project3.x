...
//  DDZClient
//
//  Created by moxinyao on 15/3/19.
//
//

#ifndef DDZClient_protocol_h
#define DDZClient_protocol_h
...
// 点
#define Vec2(__X__,__Y__)				CGVec2(__X__,__Y__)
...
// size
#define ccs(__W__, __H__)				CGSize(__W__, __H__)
...
// 点size转换
#define ccpWithSize(size)               CGVec2(size.width,size.height)
#define ccsWithPoint(point)             CGSize(point.x,point.y)

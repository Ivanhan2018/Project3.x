...
bool PropLayer::init()
{
	...
	do 
	{
		...
		/**添加文字提示**/
		LabelTTF *pTextWaring0 =LabelTTF::create(ConfigMgr::instance()->text("t152"),"HelveticaNeue-Bold",22);
		pTextWaring0->setPosition(Vec2(winSize.width*0.5,winSize.height*0.683));
		this->addChild(pTextWaring0,3);

		LabelTTF *pTextWaring1 =LabelTTF::create(ConfigMgr::instance()->text("t153"),"HelveticaNeue-Bold",22);

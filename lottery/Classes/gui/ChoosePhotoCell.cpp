...
bool ChoosePhotoCell::initPhotoCellWith(int type){
		...
		/*layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t29"),Vec2(82.0f,80.0f));
...
void ChoosePhotoCell:: choosePhoto(Object* obj){
	...
	CallFunc * funcall= CallFunc::create(this, callfunc_selector(ChoosePhotoCell::callbackC));

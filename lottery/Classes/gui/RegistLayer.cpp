...
bool RegistLayer::init()
{
	...
	do 
	{
		...
		Color3B whiteColor = ccc3(255,255,255);
		Color3B blackColor = ccc3(0,0,0);
		...
		float fontSize = 38;
		LabelTTF *title = LabelTTF::create(ConfigMgr::instance()->text("display_text.xml", "t6"), "", fontSize);
		...
		LabelTTF *accountsTitle = LabelTTF::create(ConfigMgr::instance()->text("display_text.xml", "t2"), "", fontSize);
		...
		LabelTTF *passwordTitle = LabelTTF::create(ConfigMgr::instance()->text("display_text.xml", "t3"), "", fontSize);
		...
		LabelTTF *passwordOkTitle = LabelTTF::create(ConfigMgr::instance()->text("display_text.xml", "t7"), "", fontSize);
		...
		m_pUserNameKuang = EditBox::create(cocos2d::Size(passwordInputWidth, 48), "blank.png");
		...
		m_pUserNameKuang->setFont("",fontSize);
		m_pUserNameKuang->setColor(ccc3(112,112,112));
		m_pUserNameKuang->setPlaceHolder(ConfigMgr::instance()->text("display_text.xml", "t4"));
		m_pUserNameKuang->setPlaceholderFontColor(ccc3(160,160,160));
		m_pUserNameKuang->setPlaceholderFontSize(placeHolderFontSize);

		m_pPassWordKuang = EditBox::create(cocos2d::Size(passwordInputWidth,48), "blank.png");
		...
		m_pPassWordKuang->setFont("",fontSize);
		m_pPassWordKuang->setColor(ccc3(112,112,112));
		m_pPassWordKuang->setPlaceHolder(ConfigMgr::instance()->text("display_text.xml", "t5"));
		m_pPassWordKuang->setPlaceholderFontColor(ccc3(160,160,160));
		m_pPassWordKuang->setPlaceholderFontSize(placeHolderFontSize);

		m_pPassWordKuangOK = EditBox::create(cocos2d::Size(passwordInputWidth,48), "blank.png");
		...
		m_pPassWordKuangOK->setFont("",fontSize);
		m_pPassWordKuangOK->setColor(ccc3(112,112,112));
		m_pPassWordKuangOK->setPlaceHolder(ConfigMgr::instance()->text("display_text.xml", "t8"));
		...
		fontSize = 30;
		LabelTTF *hintLabel = LabelTTF::create(ConfigMgr::instance()->text("display_text.xml", "t9"), "", fontSize);

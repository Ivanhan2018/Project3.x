...
bool GetCharge::initGetCharge(Vec2 pos)
{
   ...
   this->addChild(m_pDogetMenu);
	...
	/**领话费**/
	const char* str1 = String::createWithFormat("%s%s%s",ConfigMgr::instance()->text("t67"),addCommaToNumber(lGold).c_str(),ConfigMgr::instance()->text("t74"))->getCString();
   ...
   this->addChild(m_pTips11);
	...
	m_pTips14 =LabelTTF::create(ConfigMgr::instance()->text("t169"), "Helvetica-Bold",14);
   ...
   this->addChild(m_pInputBox2);
    ...
    //领QB
	const char* str2 = String::createWithFormat("%s%s%s",ConfigMgr::instance()->text("t67"),addCommaToNumber(lGold).c_str(),ConfigMgr::instance()->text("t75"))->getCString();
   ...
   this->addChild(m_pTips21);
	...
	m_pTips24 =LabelTTF::create(ConfigMgr::instance()->text("t169"), "Helvetica-Bold",14);
...
//    str311.insert(str311.find("点"), addCommaToNumber(lGold).c_str());
   ...
   this->addChild(m_pTips31);
	...
	m_pTips34 =LabelTTF::create(ConfigMgr::instance()->text("t169"), "Helvetica-Bold",14);
	...
	LabelTTF* m_ElseLabel = LabelTTF::create(ConfigMgr::instance()->text("t480"),"",15);
...
void GetCharge::doget(Object* obj)
{
    ...
    if(currentSelct != 1)
	{
		...
		if(!m_bEnoughGet)
		{
			...
			const char* str22 = String::createWithFormat("%s %s %s",ConfigMgr::instance()->text("t79"),addCommaToNumber(15000-lGold).c_str(),ConfigMgr::instance()->text("t80"))->getCString();
			const char* str33 = String::createWithFormat("%s %s %s",ConfigMgr::instance()->text("t79"),addCommaToNumber(15000-lGold).c_str(),ConfigMgr::instance()->text("t81"))->getCString();
			if(currentSelct == 0)
			{

...
{
	//MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(String::createWithFormat("%s%d!",ConfigMgr::instance()->text("t128"), TaskInfo::ShareTaskInfo()->m_nTaskConfig[1])->getCString(),Vec2(427,240));

...
void FreeLayer::onGetDownData(Object* obj)
{
	...
	LabelTTF* labelTips = LabelTTF::create(ConfigMgr::instance()->text("t474"),"",22);
...
{
	MovingLabelLayer* moveingLabel = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t473"),Vec2(427,240));
...
bool FreeLayer::init()
{
	...
	do 
	{
		...
		LabelTTF* label = LabelTTF::create(ConfigMgr::instance()->text("t20"),"",30);

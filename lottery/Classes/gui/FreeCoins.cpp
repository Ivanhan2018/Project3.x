...
bool FreeCoins::init()
{
	...
	float textWidth = 500;
	almsText = LabelTTF::create(ConfigMgr::instance()->text("t552"),"",18,cocos2d::Size(textWidth,0),kCCTextAlignmentLeft);
	almsText->setColor(ccc3(189,154,97));
	almsText->setAnchorPoint(Vec2(0,1));
	almsText->setPosition(Vec2(266,363));
	this->addChild(almsText);

	recommendText = LabelTTF::create(ConfigMgr::instance()->text("t553"),"",18,cocos2d::Size(textWidth,0),kCCTextAlignmentLeft);
	...
	recommenderText = LabelTTF::create(ConfigMgr::instance()->text("t554"),"",18,cocos2d::Size(textWidth,0),kCCTextAlignmentLeft);
	...
	//�Ƽ���
	recommenderLabel = LabelTTF::create(ConfigMgr::instance()->text("t555"),"",30,cocos2d::Size(textWidth,0),kCCTextAlignmentLeft);
...
void FreeCoins::pressGetCoins( Object* obj)
{
	...
	}else if(currentItem == FreeCoinsTabRecommender)
	{
		...
		request->release();//����release()
            ...
            promptBox = PromptBox::PromptBoxWith(Vec2(winSize.width * 0.5,winSize.height * 0.5),mPromptTypeGetError);
            promptBox->setPromptText(ConfigMgr::instance()->text("t1006"));
           this->addChild(promptBox,2);
        }
	}
}

...
bool OverRegistLayer::init()
{
	...
	/*	Sprite *pDiKuang0 = Sprite::create("dt_register_16.png");	
		...
		/*LabelTTF *pTTF00=LabelTTF::create(ConfigMgr::instance()->text("t103") ,"HelveticaNeue-Bold",18);
		LabelTTF *pTTF01=LabelTTF::create(ConfigMgr::instance()->text("t104") ,"HelveticaNeue-Bold",12);
		LabelTTF *pTTF10=LabelTTF::create(ConfigMgr::instance()->text("t105") ,"HelveticaNeue-Bold",18);
		LabelTTF *pTTF11=LabelTTF::create(ConfigMgr::instance()->text("t106") ,"HelveticaNeue-Bold",12);
		LabelTTF *pTTF20=LabelTTF::create(ConfigMgr::instance()->text("t107") ,"HelveticaNeue-Bold",18);
		LabelTTF *pTTF21=LabelTTF::create(ConfigMgr::instance()->text("t108"), "HelveticaNeue-Bold",12);
		LabelTTF *pTTF30=LabelTTF::create(ConfigMgr::instance()->text("t109") ,"HelveticaNeue-Bold",18);
		LabelTTF *pTTF31=LabelTTF::create(ConfigMgr::instance()->text("t110") ,"HelveticaNeue-Bold",12);
...
void OverRegistLayer::onOverRes(Object* obj)
{
	...
	switch(inter->getValue())
	{
		case 0:
			{
				...
				layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t464"),Vec2(427,240));
				Scene* scene = Scene::create();
		...
		case 1:
			{
				layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t468"),Vec2(427,240));
				break;
			}
		case 2:
			{
				layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t465"),Vec2(427,240));
				break;
			}
		case 3:
			{
				layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t466"),Vec2(427,240));
				break;
			}
		case 4:
			{
				layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t467"),Vec2(427,240));
				break;
			}
		default:
			break;
...
void OverRegistLayer::showPlayerXieYi(Object *obj){
	...
	{
		MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t28"),Vec2(winSize.width * 0.5,winSize.height * 0.5));
		this->addChild(layer,10);
		return;
	}
	...
	{
		MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t29"),Vec2(winSize.width * 0.5,winSize.height * 0.5));
		this->addChild(layer,10);
		return;
	}
	...
	{
		MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t457"),Vec2(winSize.width * 0.5,winSize.height * 0.5));
		this->addChild(layer,10);
		return;
	}
	...
	{
		MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("t30"),Vec2(winSize.width * 0.5,winSize.height * 0.5));
		this->addChild(layer,10);
		return;
	}

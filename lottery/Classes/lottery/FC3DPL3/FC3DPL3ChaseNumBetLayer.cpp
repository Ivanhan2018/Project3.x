...
Scene* FC3DPL3ChaseNumBetLayer::scene()
{
	Scene *scene = Scene::create();
	FC3DPL3ChaseNumBetLayer *layer = FC3DPL3ChaseNumBetLayer::create();
	scene->addChild(layer);
	return scene;
}

FC3DPL3ChaseNumBetLayer::FC3DPL3ChaseNumBetLayer()
{
	gameKyTe = NULL;
	gameKind = NULL;
	betZhuShu = NULL;
	...
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3ChaseNumBetLayer::TouZhuZhuiHaoButton), "TouZhuChaseNumBer", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3ChaseNumBetLayer::changeKind), "GDselectedItemTagNumberCartFailed", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3ChaseNumBetLayer::touZhuContinueRet), "CQSSCRetZhuiHao", NULL);

	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3ChaseNumBetLayer::IsFendanHourRet), "IsFendanHourRet", NULL);
}
FC3DPL3ChaseNumBetLayer::~FC3DPL3ChaseNumBetLayer()
{
...
bool FC3DPL3ChaseNumBetLayer::init()
{
	if (!Layer::init())
	{
		return false;
...
void FC3DPL3ChaseNumBetLayer::initData()
{
	winSize = Director::getInstance()->getWinSize();
}

void FC3DPL3ChaseNumBetLayer::initView()
{
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton, pCloseSelectButton, CC_CALLBACK_1(FC3DPL3ChaseNumBetLayer::back,this));
	...
	TouZhuJinEChaseNumBerLabel->setPosition(Vec2(winSize.width*0.03,100));
	...
	ButtonCodeRecordItem = MenuItemSprite::create(ButtonCodedImage, ButtonCodeNormalImage, CC_CALLBACK_1(FC3DPL3ChaseNumBetLayer::XuanZeZhuiHaoQiShu,this));
	...
	betRecordItem = MenuItemSprite::create(winningRecordSelectedImage,contiRecordNormalImage,CC_CALLBACK_1(FC3DPL3ChaseNumBetLayer::IsEndeBeiTou,this));
	...
	GetRecordItem = MenuItemSprite::create(betRecordNormalImage,betRecordSelectedImage,CC_CALLBACK_1(FC3DPL3ChaseNumBetLayer::IsEndeZhuiHao,this));
	...
	StramItem = MenuItemSprite::create(StramNormalImage_1,StramNormalImage_2,CC_CALLBACK_1(FC3DPL3ChaseNumBetLayer::betRecord,this));
	CloseItem = MenuItemSprite::create(CloseNormalImage_1,CloseNormalImage_2,CC_CALLBACK_1(FC3DPL3ChaseNumBetLayer::ZhuiHaoCloseButton,this));
...
//top menu
void FC3DPL3ChaseNumBetLayer::setting(Object* obj)
{
	playButtonSound();
...
void FC3DPL3ChaseNumBetLayer::back(Object *obj)
{
	playButtonSound();
...
//transaction menu
void FC3DPL3ChaseNumBetLayer::recharge(Object* obj)
{

}

void FC3DPL3ChaseNumBetLayer::withdraw(Object *obj)
{

}
void FC3DPL3ChaseNumBetLayer::ZhuiHaoCloseButton(Object *obj)
{
	this->setPositionY(2000);
	NotificationCenter::getInstance()->postNotification("ChaseNumBerItem");
}
...
//record menu
void FC3DPL3ChaseNumBetLayer::changeKind(Object *obj)
{
...
void FC3DPL3ChaseNumBetLayer::ShowZhuiHaoMen()
{
...
void FC3DPL3ChaseNumBetLayer::dissZhuiHaoMen()
{
...
void FC3DPL3ChaseNumBetLayer::TouZhuZhuiHaoButton(Object *obj)
{
...
void FC3DPL3ChaseNumBetLayer::betRecord(Object *obj)
{
	playButtonSound();
...
void FC3DPL3ChaseNumBetLayer::IsFendanHourRet(Object *obj)
{
	float TouZhuJinE =0;
	...
	for(int id = 0;id < MyBetNumber::getInstance()->size();id ++)
	{
		...
		EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC_ZhioHao(zhuiHaoQiShu, qiShu, tempInfo.m_gameKind->getValue(), BetLimit::GetWanfaIdFromId(tempInfo.m_wanFaKind->getValue(),3),
...
void FC3DPL3ChaseNumBetLayer::touZhuContinueRet(Object *obj)
{
...
void FC3DPL3ChaseNumBetLayer::ZhuiHaoQiShuRecord(Object *obj)
{
}

void FC3DPL3ChaseNumBetLayer::contiRecord(Object *obj)
{
}

void FC3DPL3ChaseNumBetLayer::onEnter()
{
	Layer::onEnter();
}

void FC3DPL3ChaseNumBetLayer::onExit()
{
	Layer::onExit();
}

void FC3DPL3ChaseNumBetLayer::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
cocos2d::Size FC3DPL3ChaseNumBetLayer::cellSizeForTable(TableView *table)
{
	cocos2d::Size size;
...
ssize_t FC3DPL3ChaseNumBetLayer::numberOfCellsInTableView(TableView *table)
{
	int tag = dynamic_cast<Node*>(table)->getTag();
...
TableViewCell *FC3DPL3ChaseNumBetLayer::tableCellAtIndex(TableView *table, ssize_t index)
{
	...
	if(tag == 1111){
		...
		XuanZeQiShuItem = MenuItemSprite::create(XuanZeQiShuNormalImage,XuanZeQiShuSelectedImage,CC_CALLBACK_1(FC3DPL3ChaseNumBetLayer::XuanZeQiShu,this));
...
void FC3DPL3ChaseNumBetLayer::tableCellTouched(TableView *table, TableViewCell *cell)
{
...
void FC3DPL3ChaseNumBetLayer::scrollViewDidScroll(ScrollView* view)
{

}
void FC3DPL3ChaseNumBetLayer::scrollViewDidZoom(ScrollView* view)
{

}
void FC3DPL3ChaseNumBetLayer::XuanZeQiShu(Object *obj)
{
...
void FC3DPL3ChaseNumBetLayer::XuanZeZhuiHaoQiShu(Object *obj)
{
	playButtonSound();
...
void FC3DPL3ChaseNumBetLayer::IsEndeBeiTou(Object *obj)
{
	playButtonSound();
...
void FC3DPL3ChaseNumBetLayer::IsEndeZhuiHao(Object *obj)
{
	playButtonSound();
...
void FC3DPL3ChaseNumBetLayer::editBoxEditingDidEnd(EditBox* editBox)
{
	string nMoshiString = CtratebeilvInput->getText();
	int nBeiShu = atoi(nMoshiString.c_str());
	if(nBeiShu < 1)

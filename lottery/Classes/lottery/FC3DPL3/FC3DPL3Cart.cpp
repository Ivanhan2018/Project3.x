...
Scene* FC3DPL3Cart::scene()
{
	Scene *scene = Scene::create();
	FC3DPL3Cart *layer = FC3DPL3Cart::create();
	scene->addChild(layer);
	return scene;
}
FC3DPL3Cart::FC3DPL3Cart()
{
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Cart::ZhuiHaoback), "ZhuiHaoback", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Cart::SetusedBonusRet), "SetusedBonusRet", NULL);	
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Cart::pressChaseNumShow), "ChaseNumBerItem", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Cart::RemoveCurrentLayer), "RemoveCurrentLayer", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Cart::RefreshData), "RefreshData", NULL);
}
FC3DPL3Cart::~FC3DPL3Cart()
{	
	if(gameResultTable)
...
void FC3DPL3Cart::initView()
{
	auto listener = EventListenerTouchOneByOne::create();
	listener->setSwallowTouches(true);
	listener->onTouchBegan = CC_CALLBACK_2(FC3DPL3Cart::onTouchBegan,this);
	listener->onTouchEnded = CC_CALLBACK_2(FC3DPL3Cart::onTouchEnded,this);
	listener->onTouchMoved = CC_CALLBACK_2(FC3DPL3Cart::onTouchMoved,this);
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(FC3DPL3Cart::back,this));
	...
	confirmItem = MenuItemSprite::create(confirmNormalImage,confirmSelectedImage,CC_CALLBACK_1(FC3DPL3Cart::confirm,this));
	MenuItemSprite *ZhuiHaoItem = MenuItemSprite::create(ZhuiHaoNormalImage,ZhuiHaoSelectedImage,CC_CALLBACK_1(FC3DPL3Cart::ZhuiHaoItemMinusobj,this));
	...
	fontSize = 30;
	KindTTfle = LabelTTF::create(ConfigMgr::instance()->text("display_DuangDong.xml", "t401"), "", fontSize);
	...
	MenuItemSprite *addRandomItem = MenuItemSprite::create(addRandomNormalImage,addRandomSelectedImage,CC_CALLBACK_1(FC3DPL3Cart::deleRandom,this));
	...
	ZhuiHao11Xuan5Cart = FC3DPL3ChaseNumBetLayer::create();
...
void FC3DPL3Cart::updateBetInfo()
{
	int totalZhuShu = 0;
	float totalMoney = 0;
...
void FC3DPL3Cart::ZhuiHaoItemMinusobj(Object *obj)
{
	playButtonSound();
...
void FC3DPL3Cart::pressChaseNumShow(Object *obj)
{
	ShowIsChaseNum();
	this->setKeypadEnabled(true);
}

void FC3DPL3Cart::SetusedBonusRet(Object *obj)
{
...
void FC3DPL3Cart::ZhuiHaoback(Object *obj)
{
	back(NULL);
}

void FC3DPL3Cart::back(Object *obj)
{
	playButtonSound();
...
void FC3DPL3Cart::ShowIsChaseNum()
{
...
void FC3DPL3Cart::dissisChaseNum()
{
...
//transaction menu
void FC3DPL3Cart::confirm(Object* obj)
{
	playButtonSound();
...
void FC3DPL3Cart::bottomMenuEnabled(bool GuangDong11Xuan5BoolSuccen)
{
...
void FC3DPL3Cart::deleRandom(Object* obj)
{
	playButtonSound();
...
void FC3DPL3Cart::onEnter()
{
	Layer::onEnter();

}

void FC3DPL3Cart::onExit()
{
	Layer::onExit();
}

void FC3DPL3Cart::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
cocos2d::Size FC3DPL3Cart::cellSizeForTable(TableView *table)
{
	cocos2d::Size size;
...
ssize_t FC3DPL3Cart::numberOfCellsInTableView(TableView *table)
{
	return MyBetNumber::getInstance()->size() + 1;

}
TableViewCell *FC3DPL3Cart::tableCellAtIndex(TableView *table,ssize_t index)
{
...
void FC3DPL3Cart::tableCellTouched(TableView *table, TableViewCell *cell)
{
...
void FC3DPL3Cart::scrollViewDidScroll(ScrollView* view)
{

}
void FC3DPL3Cart::scrollViewDidZoom(ScrollView* view)
{

}

bool FC3DPL3Cart::onTouchBegan(Touch *pTouch, Event *pEvent)
{
...
void FC3DPL3Cart::onTouchMoved(Touch *pTouch, Event *pEvent)
{

}

void FC3DPL3Cart::onTouchEnded(Touch *pTouch, Event *pEvent)
{	
	Vec2 pos = Director::getInstance()->convertToGL(pTouch->getLocationInView());
	endPoint = pos;
...
void FC3DPL3Cart::pressDeleteButton(int index)
{
	NotificationCenter::getInstance()->postNotification("DeleteItem", Integer::create(index));
}

void FC3DPL3Cart::RemoveCurrentLayer(Object *obj)
{
	this->setPositionY(2000);
	this->ShowIsChaseNum();	
}

void FC3DPL3Cart::RefreshData(Object *obj)
{

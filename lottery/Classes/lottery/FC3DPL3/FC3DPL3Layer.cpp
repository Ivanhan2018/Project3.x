...
void addRandSeedThreeNumbersKind()
{
	timeval psv;	
...
FC3DPL3Layer::FC3DPL3Layer()
{
	addRandSeedThreeNumbersKind();
	wKindID = NULL;
	wPeriod = NULL;
	szLotNum = NULL;
	szShijian = NULL;
	...
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::GetLastYueRet), "GetLastYueRet", NULL);  ///余额查询
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::ShiYiXuanWoNumber), "ShiYiXuanWoNumber", NULL);  ///追号所花费的金额
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::ZhuiHaoTouZhuJinENumber), "ZhuiHaoTouZhuJinENumber", NULL);  ///追号所花费的金额
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::queryGameRet), "QueryGameRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::touZhuRet), "CQSSCRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::changeKind), "CQSSCChangeKind", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::deleteItem), "DeleteItem", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::addRandomItem), "AddRandomItem", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::CartConfirm), "CartConfirm", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::clearNumbers), "ClearNumbers", NULL);
	//NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::getSystemTimeObject), "GetSystemTimeRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::updateTouZhuJine), "UpdateTouZhuJine", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::KindMyFanDianRet), "QueryMyFanDianRet", NULL);

	//追号验证
	NotificationCenter::getInstance()->addObserver(this,callfuncO_selector(FC3DPL3Layer::isFenDanHour), "IsFendanHour", NULL);

	//跨年期号处理
	NotificationCenter::getInstance()->addObserver(this,callfuncO_selector(FC3DPL3Layer::kuaNianExpect), "KuaNian", NULL);

	//结果查询
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(FC3DPL3Layer::queryGameMoreRet), "QueryMoreGameRet", NULL);
}

void FC3DPL3Layer::getSystemTime(float dt)
{
...
FC3DPL3Layer::~FC3DPL3Layer()
{
	...
	this->unschedule(schedule_selector(FC3DPL3Layer::updatePeriod));
	this->unschedule(schedule_selector(FC3DPL3Layer::getSystemTime));
	this->unschedule(schedule_selector(FC3DPL3Layer::myUpdate));
...
void FC3DPL3Layer::updatePeriod(float dt)
{
	EntityMgr::instance()->getDispatch()->SendPacketQueryGameResult(gameKind);
}

void FC3DPL3Layer::refreshLayer()
{
	//更新期号
	EntityMgr::instance()->getDispatch()->SendPacketQueryGameResult(gameKind);
	//更新余额
	...
	//更新奖金
	EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC_FanDian(gameKind, BetLimit::GetWanfaIdFromId(wanFaKind,3));
...
void FC3DPL3Layer::setWanFaKind(ThreeNumbersKind kind)
{
	wanFaKind = kind;
...
void FC3DPL3Layer::myUpdate(float dt)
{
...
void FC3DPL3Layer::getSystemTimeObject(Object *obj)
{
...
void FC3DPL3Layer::initData()
{
	wanFaKind = enWF_QianyizhixuanFushi;
...
void FC3DPL3Layer::initView()
{
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(FC3DPL3Layer::back,this));
	...
	MenuItemSprite *setupItem = MenuItemSprite::create(setupItemNormalImage,setupItemSelectedImage,CC_CALLBACK_1(FC3DPL3Layer::setting,this));
	...
	//MenuItemLabel *lbItem = MenuItemLabel::create(moreItemLabel,CC_CALLBACK_1(FC3DPL3Layer::jumpResult,this));
	...
	MenuItemSprite *deleteItem = MenuItemSprite::create(deleteNormalImage,deleteSelectedImage,CC_CALLBACK_1(FC3DPL3Layer::toDelete,this));
	MenuItemSprite *randomGambleItem = MenuItemSprite::create(randomNormalImage,randomSelectedImage,CC_CALLBACK_1(FC3DPL3Layer::toRandomGamble,this));
	...
	moreItem = MenuItemSprite::create(moreNormalImage2,moreSelectedImage2,CC_CALLBACK_1(FC3DPL3Layer::toMore,this));
	...
	MenuItemSprite *beiAddItem = MenuItemSprite::create(beiAdd,beiAddPress,CC_CALLBACK_1(FC3DPL3Layer::beiAdd,this));
	MenuItemSprite *beiMinusItem = MenuItemSprite::create(beiMinus,beiMinusPress,CC_CALLBACK_1(FC3DPL3Layer::beiMinus,this));
	...
	MenuItemSprite *FanDianSelectedImage = MenuItemSprite::create(FanDianSprite_1,FanDianSprite_2,CC_CALLBACK_1(FC3DPL3Layer::FanDianMinus,this));
	...
	cartItem = MenuItemSprite::create(cartNormalImage,cartSelectedImage,CC_CALLBACK_1(FC3DPL3Layer::toGamble,this));
	MenuItemSprite *confirmItem = MenuItemSprite::create(confirmNormalImage,confirmSelectedImage,CC_CALLBACK_1(FC3DPL3Layer::toCart,this));
	...
	YuanSelectedImageLayer = MenuItemSprite::create(YuanSprite_1,YuanSprite_2,YuanSprite_3,CC_CALLBACK_1(FC3DPL3Layer::XuanZeMonenyLayer,this));
	YuanSelectedImageLayer->setTag(YuanShiShiCAITag);
	JiaoSelectedImageLayer = MenuItemSprite::create(JiaoSprite_1,JiaoSprite_2,JiaoSprite_3,CC_CALLBACK_1(FC3DPL3Layer::XuanZeMonenyLayer,this));
	JiaoSelectedImageLayer->setTag(JiaoShiShiCAITag);
	FenSelectedImageLayer = MenuItemSprite::create(FenSprite_1,FenSprite_2,FenSprite_3,CC_CALLBACK_1(FC3DPL3Layer::XuanZeMonenyLayer,this));
	FenSelectedImageLayer->setTag(FenShiShiCAITag);
	//新增厘模式
	LiSelectedImageLayer = MenuItemSprite::create(LiSprite_1, LiSprite_2, LiSprite_3,CC_CALLBACK_1(FC3DPL3Layer::XuanZeMonenyLayer, this));
	...
	refreshListener->onTouchEnded = [=](Touch *pTouch, Event *pEvent){
		...
		{		
			//下拉刷新图标
			if(m_bIsOpenList && listTable->getContentOffset().y < -350)
			{
				isRun = true;
...
void FC3DPL3Layer::queryGameRet(Object *obj)
{
	...
	for (int i = 0; i < count; i += 4){
		...
		if (id->getValue() == gameKind){
			...
			szLotNum->retain();
			szShijian->retain();
			if (id->getValue() == CZ3D || id->getValue() == CZPailie3)
			{
				memset(CFC3DRule::m_lastExpect, 0, KJ_QIHAO_LENGTH);
				memset(CFC3DRule::m_lastKjShj, 0, KJ_SHIJIAN_LENGTH);
				string strExpect = mPeriod->getCString();
				if (strExpect.substr(0, 2) != "20")
					strExpect = "20" + strExpect;
				memcpy(CFC3DRule::m_lastExpect, strExpect.c_str(), strExpect.length());
				memcpy(CFC3DRule::m_lastKjShj, szShijian->getCString(), strlen(szShijian->getCString()));
			}
			//this->updateLotteryId();
			//this->updateCurrentTime();
			break;
...
void FC3DPL3Layer::updateLotteryId()
{
...
void FC3DPL3Layer::updateCurrentTime()
{
	String *headStr = NULL;
...
void FC3DPL3Layer::touZhuRet(Object *obj)
{
...
//top menu
void FC3DPL3Layer::setting(Object* obj)
{
	playButtonSound();
...
void FC3DPL3Layer::jumpResult(Object* obj)
{	
	playButtonSound();	
...
void FC3DPL3Layer::XuanZeMonenyLayer(Object *obj)
{
	//playButtonSound();
...
//middle menu
void FC3DPL3Layer::toMore(Object* obj)
{
...
void FC3DPL3Layer::toRandomGamble(Object* obj)
{
	playButtonSound();
...
void FC3DPL3Layer::ZhuiHaoTouZhuJinENumber(Object *obj)
{
...
void FC3DPL3Layer::ShiYiXuanWoNumber(Object *obj)
{
...
//bottom menu
void FC3DPL3Layer::toDelete(Object* obj)
{
	playButtonSound();
	if(betArea != NULL)
	{
...
void FC3DPL3Layer::toCart(Object* obj)
{
	playButtonSound();
	...
	if(!bRet)
	{
		...
		//判断注数限制
		int maxCount = BetLimit::GetMaxBetFromId(gameKind,BetLimit::GetWanfaIdFromId(wanFaKind,3));
		int nowTouzhu = betZhuShuTouZhuJinE;
		if(maxCount < nowTouzhu)
		{
			std::string strDisplay =
				BetLimit::GetWanFaNameFromId(gameKind,BetLimit::GetWanfaIdFromId(wanFaKind,3)) +
		...
		if(!BetLimit::CheckDingWeiDanStr(BetLimit::GetWanfaIdFromId(wanFaKind,3),betNumber->getCString()))
		{
		...
		else if (strcmp(betNumber->getCString(), "SI") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t192"),
				Vec2(winSize.width * 0.5, winSize.height * 0.5));
			this->addChild(layer, 255);
		...
		else if (strcmp(betNumber->getCString(), "ZU3") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t197"),
				Vec2(winSize.width * 0.5, winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}
		...
		Integer* b_wanFaKind = Integer::create(BetLimit::GetWanfaIdFromId(wanFaKind,3));
...
void FC3DPL3Layer::toGamble(Object* obj)
{
	playButtonSound();
	...
	if(!bRet)
	{
		...
		int TempWanfaKind = BetLimit::GetWanfaIdFromId(wanFaKind, 3);
		
		EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC(qishuStr, gameKind, TempWanfaKind,
...
void FC3DPL3Layer::changeKind(Object *obj)
{
	selectedItemTag = ((Integer *)obj)->getValue(); 
	//保存
	MyBetData::getInstance()->setLastWanfaId(treeNumbersMap[selectedItemTag]);
	//
	...
	this->setWanFaKind(treeNumbersMap[selectedItemTag]);
	betArea->clearNumbers();
	betArea->cancelAllMenuSelect();
	betZhuShuTouZhuJinE = 0;
...
void FC3DPL3Layer::onEnter()
{
	BaseLayer::onEnter();
}

void FC3DPL3Layer::onExit()
{
	BaseLayer::onExit();
}

void FC3DPL3Layer::back(cocos2d::Object *obj)
{
	playButtonSound();
...
void FC3DPL3Layer::onKeyReleased(EventKeyboard::KeyCode keycode, cocos2d::Event *event)
{
...
void FC3DPL3Layer::showKindView()
{
	...
	//彩种下拉框选择
	kindLayer = FC3DPL3KindScrollView::create();
...
void FC3DPL3Layer::hideKindView()
{
	LayerColor* layer = (LayerColor *)this->getChildByTag(9527);
	if(layer == nullptr) return;
...
void FC3DPL3Layer::isCartShow()
{
	MonenyMenuLayer->setEnabled(true);
}
void FC3DPL3Layer::isCartdiss()
{
	MonenyMenuLayer->setEnabled(false);
}
void FC3DPL3Layer::isCartShowLayer(cocos2d::Object *obj)
{
	this->isCartShow();
}


void FC3DPL3Layer::addRandomItem(cocos2d::Object *obj)
{
	isCartShow();
	this->setKeypadEnabled(true);
	betZhuShuTouZhuJinE = 0.00;
...
void FC3DPL3Layer::CartConfirm(cocos2d::Object *obj)
{
	...
	for(int i = 0 ; i < MyBetNumber::getInstance()->size();i ++){
		...
		int TempWanfaKind = wanFaKind->getValue();
		
		EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC(qishuStr, gameKind->getValue(), TempWanfaKind,
...
void FC3DPL3Layer::clearNumbers(cocos2d::Object *obj)
{
	 MyBetNumber::getInstance()->clear();

	 NotificationCenter::getInstance()->postNotification("RefreshData", nullptr);
}
void FC3DPL3Layer::deleteItem(cocos2d::Object *obj)
{
...
void FC3DPL3Layer::setGameKind(CaiZhong kind)
{
	//初始化数据
	MyBetData::getInstance()->setCurCaiZhongId(kind);

	int last = MyBetData::getInstance()->getLastWanfaId();
	if(last == -1) last = treeNumbersMap[1];

	this->setWanFaKind((ThreeNumbersKind)last);
	selectedItemTag = 1;

	for(int i = 0;i < MyBetData::getInstance()->getWanfaSize();i ++)
	{
		if(treeNumbersMap[MyBetData::getInstance()->getWanfaAt(i)] == last)
		{
	...
	EntityMgr::instance()->getDispatch()->SendPacketQueryMoreGameResult(gameKind);
	EntityMgr::instance()->getDispatch()->SendPacketQueryGameResult(gameKind);
	this->schedule(schedule_selector(FC3DPL3Layer::updatePeriod), 3);

	//跨年处理
#if 1
	EntityMgr::instance()->getDispatch()->SendPacketWithGetKuaNianQiHao(gameKind);
	this->schedule(schedule_selector(FC3DPL3Layer::getSystemTime), 3);	
#endif

	this->schedule(schedule_selector(FC3DPL3Layer::myUpdate), 1);
	...
	if(gameRule == NULL){
		...
		else if (gameKind == CZPailie3)
		{
			gameRule = new CPL3Rule();
		}
...
void FC3DPL3Layer::updateTouZhuJine(Object *obj)
{
	betArea->getBetNumber();
	betZhuShuTouZhuJinE = betArea->getBetZhuShu();
...
void FC3DPL3Layer::GetLastYueRet(Object *obj)
{
...
//------------------------------------------------新增----------------------------------------------------------------
void FC3DPL3Layer::editBoxEditingDidEnd(EditBox* editBox)
{
...
void FC3DPL3Layer::FanDianMinus(Object *obj)
{
	playButtonSound();
	//创建半透明层
	...
	listener->onTouchBegan = CC_CALLBACK_2(FC3DPL3Layer::onTouchBegan,this);
	listener->onTouchEnded = CC_CALLBACK_2(FC3DPL3Layer::onTouchEnded,this);
	listener->onTouchMoved = CC_CALLBACK_2(FC3DPL3Layer::onTouchMoved,this);
	...
	MenuItemSprite* MakeSureMenuItem = MenuItemSprite::create(MakeSureSprite_1,MakeSureSprite_2,CC_CALLBACK_1(FC3DPL3Layer::SuccenGameResume,this));
	MenuItemSprite* PCloseItemMenuItem = MenuItemSprite::create(PCloseItem_1,PCloseItem_2,CC_CALLBACK_1(FC3DPL3Layer::pCoseGameResume,this));
	...
	MenuItemSprite* MinusMenuItem = MenuItemSprite::create(MinusValueSprite_1,MinusValueSprite_2,CC_CALLBACK_1(FC3DPL3Layer::PlusFianDian,this));
	MinusMenuItem->setAnchorPoint(Vec2(0.5,0.5));
	MinusMenuItem->setPosition(Vec2(winSize.width*0.84 + 10,winSize.height*0.5 + tempInt));
	MenuItemSprite* PlusMenuItem = MenuItemSprite::create(PlusValueSprite_1,PlusValueSprite_2,CC_CALLBACK_1(FC3DPL3Layer::MinusFanDian,this));
...
void FC3DPL3Layer::PlusFianDian(Object *obj)
{
...
void FC3DPL3Layer::MinusFanDian(Object *obj)
{
	float PlusFanDianvalie =PlusFanDianvalieMAX;
...
void FC3DPL3Layer::pCoseGameResume(Object *obj)
{
...
void FC3DPL3Layer::SuccenGameResume(Object *obj)
{
	playButtonSound();
	...
	if(!bRet)
	{
		...
		EntityMgr::instance()->getDispatch()->SendPacketWithGetTouZhuSetUserBonus(gameKind, BetLimit::GetWanfaIdFromId(wanFaKind,3), PlusFanDianvalieMAX, BaiFenbiNumber);
	}
}

/**触摸开始*/
bool FC3DPL3Layer::onTouchBegan(Touch *pTouch, Event *pEvent)
{	
...
void FC3DPL3Layer::onTouchMoved(Touch *pTouch, Event *pEvent)
{

}

void FC3DPL3Layer::onTouchEnded(Touch *pTouch, Event *pEvent)
{	

}

void FC3DPL3Layer::KindMyFanDianRet(Object *obj)
{
	...
	int count = data->count();
	if (count == 0) return;
	int myWanFa = BetLimit::GetWanfaIdFromId(wanFaKind,3);
	for (int i = 0;i < count; i += 4)
	{
		Integer *id = (Integer*) data->objectAtIndex(i);
...
void FC3DPL3Layer::pressMinus(Object *obj)
{
...
void FC3DPL3Layer::beiAdd(Object *obj)
{
	playButtonSound();
	beiShu --;
...
void FC3DPL3Layer::beiMinus(Object *obj)
{
	playButtonSound();
	beiShu ++;
	beilvInput->setText(String::createWithFormat("%d", beiShu)->getCString());
...
void FC3DPL3Layer::updateMoneyLabel()
{
...
void FC3DPL3Layer::tableCellTouched(TableView* table, TableViewCell* cell)
{
...
cocos2d::Size FC3DPL3Layer::cellSizeForTable(TableView *table)
{
	cocos2d::Size result;
...
TableViewCell* FC3DPL3Layer::tableCellAtIndex(TableView *table, ssize_t idx)
{
	...
	if(table->getTag() == 1000) //菜单
	{
		...
		const char* tempStr = ConfigMgr::instance()->text("display_3D.xml",String::createWithFormat("t%d",20 +  treeNumbersMap[nowPos])->getCString());
...
ssize_t FC3DPL3Layer::numberOfCellsInTableView(TableView *table)
{
	if(table->getTag() == 1000) //菜单
	{
...
void FC3DPL3Layer::scrollViewDidScroll(ScrollView* view)
{

}

void FC3DPL3Layer::scrollViewDidZoom(ScrollView* view)
{

}

void FC3DPL3Layer::transferString(string &str, int nStep)
{
	bool bTeMa = false;
	int nPos = str.find("|");
	if (nPos >= 0)
...
void FC3DPL3Layer::queryGameMoreRet(Object *obj)
{

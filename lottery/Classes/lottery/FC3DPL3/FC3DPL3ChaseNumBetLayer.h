#ifndef _FC3D_PL3_ChaseNumBetLayer_H
#define _FC3D_PL3_ChaseNumBetLayer_H
...
class FC3DPL3ChaseNumBetLayer : public Layer, public TableViewDelegate,
	public TableViewDataSource, public EditBoxDelegate
{
public:
	FC3DPL3ChaseNumBetLayer();
	~FC3DPL3ChaseNumBetLayer();
	CREATE_FUNC(FC3DPL3ChaseNumBetLayer);
	virtual bool init();
	static Scene* scene();

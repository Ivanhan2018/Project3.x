...
class FC3DPL3Layer : public BaseLayer, public EditBoxDelegate,public TableViewDelegate,
	public TableViewDataSource
{
public:
    FC3DPL3Layer();
    ~FC3DPL3Layer();
    CREATE_FUNC(FC3DPL3Layer);
    virtual bool init();
    static Scene* scene();
	...
	void refreshLayer();
private:
	void setWanFaKind(ThreeNumbersKind kind);
	void initData();
	void initView();	
	...
	FC3DPL3BetArea *betArea;
	ThreeNumbersKind wanFaKind;
	FC3DPL3KindScrollView *kindLayer;	
	FC3DPL3Cart *cart;

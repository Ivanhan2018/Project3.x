#ifndef __LOTTERY__GuangDong11Xuan5CartCart__H_
#define __LOTTERY__GuangDong11Xuan5CartCart__H_
...
class LotteryCart : public Layer, public TableViewDelegate,
	public TableViewDataSource
{
public:
    LotteryCart();
    ~LotteryCart();
    CREATE_FUNC(LotteryCart);
    virtual bool init();
    static Scene* scene();
...
private:
	...
	LotteryChaseNumBerLayer* ZhuiHao11Xuan5Cart;

#ifndef __LOTTERY_ChaseNumBerLayer_H
#define __LOTTERY_ChaseNumBerLayer_H
...
class LotteryChaseNumBerLayer : public Layer, public TableViewDelegate,
	public TableViewDataSource, public EditBoxDelegate
{
public:
	LotteryChaseNumBerLayer();
	~LotteryChaseNumBerLayer();
	CREATE_FUNC(LotteryChaseNumBerLayer);
	virtual bool init();
	static Scene* scene();

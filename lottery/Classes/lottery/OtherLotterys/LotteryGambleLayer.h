#ifndef __LOTTERY_GAMBLELAYER_H__
#define __LOTTERY_GAMBLELAYER_H__
...
class LotteryGambleLayer : public BaseLayer, public EditBoxDelegate,public TableViewDelegate,
	public TableViewDataSource
{
public:
	LotteryGambleLayer();
	~LotteryGambleLayer();
	CREATE_FUNC(LotteryGambleLayer);
	virtual bool init();
	static Scene* scene();
	...
	void refreshLayer();
private:
	void setWanFaKind(QiXingCaiKind kind);
	void initData();
	void initView();	
	...
	LotteryBetArea *betArea;
	
	QiXingCaiKind wanFaKind;
	int selectedItemTag;
	float TouZhuJinE;
	float ZhangHuYuE;

#include "LotteryChaseNumBerLayer.h"
#include "RoomLayer.h"
#include "ConfigMgr.h"
...
Scene* LotteryChaseNumBerLayer::scene()
{
	Scene *scene = Scene::create();
	LotteryChaseNumBerLayer *layer = LotteryChaseNumBerLayer::create();
	scene->addChild(layer);
	return scene;
}

LotteryChaseNumBerLayer::LotteryChaseNumBerLayer()
{
	fandianStatus = 0;
	ZhuiHaoBool =0;
	BeiTouBool = 0;
	...
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryChaseNumBerLayer::TouZhuZhuiHaoButton), "TouZhuChaseNumBer", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryChaseNumBerLayer::changeKind), "GDselectedItemTagNumberCartFailed", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryChaseNumBerLayer::touZhuContinueRet), "CQSSCRetZhuiHao", NULL);

	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryChaseNumBerLayer::IsFendanHourRet), "IsFendanHourRet", NULL);
}
LotteryChaseNumBerLayer::~LotteryChaseNumBerLayer()
{
...
bool LotteryChaseNumBerLayer::init()
{
	if (!Layer::init())
	{
		return false;
...
void LotteryChaseNumBerLayer::initData()
{
	winSize = Director::getInstance()->getWinSize();
		//gameKyTe = NULL;
}

void LotteryChaseNumBerLayer::initView()
{
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(LotteryChaseNumBerLayer::back,this));
	...
	ButtonCodeRecordItem = MenuItemSprite::create(ButtonCodedImage,ButtonCodeNormalImage,CC_CALLBACK_1(LotteryChaseNumBerLayer::XuanZeZhuiHaoQiShu,this));
	...
	betRecordItem = MenuItemSprite::create(winningRecordSelectedImage,contiRecordNormalImage,CC_CALLBACK_1(LotteryChaseNumBerLayer::IsEndeBeiTou,this));
	...
	GetRecordItem = MenuItemSprite::create(betRecordNormalImage,betRecordSelectedImage,CC_CALLBACK_1(LotteryChaseNumBerLayer::IsEndeZhuiHao,this));
	...
	StramItem = MenuItemSprite::create(StramNormalImage_1,StramNormalImage_2,CC_CALLBACK_1(LotteryChaseNumBerLayer::betRecord,this));
	CloseItem = MenuItemSprite::create(CloseNormalImage_1,CloseNormalImage_2,CC_CALLBACK_1(LotteryChaseNumBerLayer::ZhuiHaoCloseButton,this));
...
//top menu
void LotteryChaseNumBerLayer::setting(Object* obj)
{
	playButtonSound();
...
void LotteryChaseNumBerLayer::back(Object *obj)
{
	playButtonSound();
...
//transaction menu
void LotteryChaseNumBerLayer::recharge(Object* obj)
{

}

void LotteryChaseNumBerLayer::withdraw(Object *obj)
{

}
void LotteryChaseNumBerLayer::ZhuiHaoCloseButton(Object *obj)
{
	playButtonSound();
...
void LotteryChaseNumBerLayer::dissZhuiHaoMen()
{
...
void LotteryChaseNumBerLayer::TouZhuZhuiHaoButton(Object *obj)
{
...
void LotteryChaseNumBerLayer::betRecord(Object *obj)
{
	playButtonSound();
...
void LotteryChaseNumBerLayer::IsFendanHourRet(Object *obj)
{	
	...
	for(int id = 0;id < MyBetNumber::getInstance()->size();id ++)
	{
		...
		EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC_ZhioHao(zhuiHaoQiShu, qiShu, tempInfo.m_gameKind->getValue(), BetLimit::GetWanfaIdFromId(tempInfo.m_wanFaKind->getValue(),4),
...
void LotteryChaseNumBerLayer::touZhuContinueRet(Object *obj)
{
...
void LotteryChaseNumBerLayer::ZhuiHaoQiShuRecord(Object *obj)
{
}

void LotteryChaseNumBerLayer::contiRecord(Object *obj)
{
}

void LotteryChaseNumBerLayer::onEnter()
{
	Layer::onEnter();
}

void LotteryChaseNumBerLayer::onExit()
{
	Layer::onExit();
}

void LotteryChaseNumBerLayer::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
cocos2d::Size LotteryChaseNumBerLayer::cellSizeForTable(TableView *table)
{
	cocos2d::Size size;
...
ssize_t LotteryChaseNumBerLayer::numberOfCellsInTableView(TableView *table)
{
	int tag = dynamic_cast<Node*>(table)->getTag();
...
TableViewCell *LotteryChaseNumBerLayer::tableCellAtIndex(TableView *table,ssize_t index)
{
	...
	if(tag == 1111){
		...
		XuanZeQiShuItem = MenuItemSprite::create(XuanZeQiShuNormalImage,XuanZeQiShuSelectedImage,CC_CALLBACK_1(LotteryChaseNumBerLayer::XuanZeQiShu,this));
...
void LotteryChaseNumBerLayer::tableCellTouched(TableView *table, TableViewCell *cell)
{
...
void LotteryChaseNumBerLayer::scrollViewDidScroll(ScrollView* view)
{

}
void LotteryChaseNumBerLayer::scrollViewDidZoom(ScrollView* view)
{

}
void LotteryChaseNumBerLayer::XuanZeQiShu(Object *obj)
{
...
void LotteryChaseNumBerLayer::XuanZeZhuiHaoQiShu(Object *obj)
{
	playButtonSound();
...
void LotteryChaseNumBerLayer::IsEndeBeiTou(Object *obj)
{
	playButtonSound();
...
void LotteryChaseNumBerLayer::IsEndeZhuiHao(Object *obj)
{
	playButtonSound();
...
void LotteryChaseNumBerLayer::editBoxEditingDidEnd(EditBox* editBox)
{
	string nMoshiString = CtratebeilvInput->getText();
	int nBeiShu = atoi(nMoshiString.c_str());

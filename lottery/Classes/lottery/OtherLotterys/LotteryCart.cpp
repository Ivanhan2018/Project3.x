...
Scene* LotteryCart::scene()
{
	Scene *scene = Scene::create();
	LotteryCart *layer = LotteryCart::create();
	scene->addChild(layer);
	return scene;
}
LotteryCart::LotteryCart()
{
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryCart::ZhuiHaoback), "ZhuiHaobackCHongQIN", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryCart::SetusedBonusRet), "SetusedBonusRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryCart::pressChaseNumShow), "ChaseNumBerItem", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryCart::RemoveCurrentLayer), "RemoveCurrentLayer", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryCart::RefreshData), "RefreshData", NULL);
}
LotteryCart::~LotteryCart()
{	
	if(gameResultTable)
...
bool LotteryCart::init()
{
	...
	listener->onTouchBegan = CC_CALLBACK_2(LotteryCart::onTouchBegan,this);
	listener->onTouchEnded = CC_CALLBACK_2(LotteryCart::onTouchEnded,this);
	listener->onTouchMoved = CC_CALLBACK_2(LotteryCart::onTouchMoved,this);
...
void LotteryCart::initView()
{
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(LotteryCart::back,this));
	...
	confirmItem = MenuItemSprite::create(confirmNormalImage,confirmSelectedImage,CC_CALLBACK_1(LotteryCart::confirm,this));
	MenuItemSprite *ZhuiHaoItem = MenuItemSprite::create(ZhuiHaoNormalImage,ZhuiHaoSelectedImage,CC_CALLBACK_1(LotteryCart::ZhuiHaoItemMinusobj,this));
	...
	MenuItemSprite *addRandomItem = MenuItemSprite::create(addRandomNormalImage,addRandomSelectedImage,CC_CALLBACK_1(LotteryCart::deleRandom,this));
	...
	ZhuiHao11Xuan5Cart = LotteryChaseNumBerLayer::create();
...
void LotteryCart::updateBetInfo()
{	
	int totalZhuShu = 0;
	float totalMoney = 0;
...
//追号
void LotteryCart::ZhuiHaoItemMinusobj(Object *obj)
{
	playButtonSound();
...
void LotteryCart::pressChaseNumShow(Object *obj)
{
	ShowIsChaseNum();
	this->setKeypadEnabled(true);
}
void LotteryCart::SetusedBonusRet(Object *obj)
{
...
void LotteryCart::ZhuiHaoback(Object *obj)
{
	playButtonSound();
	this->setPositionY(2000);
}

void LotteryCart::back(Object *obj)
{
	playButtonSound();
	this->setPositionY(2000);
...
void LotteryCart::ShowIsChaseNum()
{
...
void LotteryCart::dissisChaseNum()
{
...
//transaction menu
void LotteryCart::confirm(Object* obj)
{
	playButtonSound();
...
void LotteryCart::bottomMenuEnabled(bool GuangDong11Xuan5BoolSuccen)
{
...
void LotteryCart::deleRandom(Object* obj)
{
	playButtonSound();
...
void LotteryCart::onEnter()
{
	Layer::onEnter();

}

void LotteryCart::onExit()
{
	Layer::onExit();
}

void LotteryCart::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
cocos2d::Size LotteryCart::cellSizeForTable(TableView *table)
{
	cocos2d::Size size;
...
ssize_t LotteryCart::numberOfCellsInTableView(TableView *table)
{
	return MyBetNumber::getInstance()->size() + 1;

}
TableViewCell *LotteryCart::tableCellAtIndex(TableView *table,ssize_t index)
{
...
void LotteryCart::tableCellTouched(TableView *table, TableViewCell *cell)
{
...
void LotteryCart::scrollViewDidScroll(ScrollView* view)
{

}
void LotteryCart::scrollViewDidZoom(ScrollView* view)
{

}

bool LotteryCart::onTouchBegan(Touch *pTouch, Event *pEvent)
{
...
void LotteryCart::onTouchMoved(Touch *pTouch, Event *pEvent)
{

}

void LotteryCart::onTouchEnded(Touch *pTouch, Event *pEvent)
{	
	Vec2 pos = Director::getInstance()->convertToGL(pTouch->getLocationInView());
	endPoint = pos;
...
void LotteryCart::pressDeleteButton(int index)
{
	NotificationCenter::getInstance()->postNotification("DeleteItem", Integer::create(index));
}

void LotteryCart::RemoveCurrentLayer(Object *obj)
{
	this->setPositionY(2000);
	this->ShowIsChaseNum();	
}

void LotteryCart::RefreshData(Object *obj)
{

#ifndef __BJK8_ChaseNumBerLayer_H
#define __BJK8_ChaseNumBerLayer_H
...
class BJK8ChaseNumBerLayer : public Layer, public TableViewDelegate,
	public TableViewDataSource, public EditBoxDelegate
{
public:
	BJK8ChaseNumBerLayer();
	~BJK8ChaseNumBerLayer();
	CREATE_FUNC(BJK8ChaseNumBerLayer);
	virtual bool init();
	static Scene* scene();

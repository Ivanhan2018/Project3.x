#ifndef __BJK8__GuangDong11Xuan5CartCart__H_
#define __BJK8__GuangDong11Xuan5CartCart__H_
...
class BJK8Cart : public Layer, public TableViewDelegate,
	public TableViewDataSource
{
public:
    BJK8Cart();
    ~BJK8Cart();
    CREATE_FUNC(BJK8Cart);
    virtual bool init();
    static Scene* scene();
...
private:
	...
	BJK8ChaseNumBerLayer* ZhuiHao11Xuan5Cart;

#include "BJK8ChaseNumBerLayer.h"
#include "RoomLayer.h"
#include "ConfigMgr.h"
...
Scene* BJK8ChaseNumBerLayer::scene()
{
	Scene *scene = Scene::create();
	BJK8ChaseNumBerLayer *layer = BJK8ChaseNumBerLayer::create();
	scene->addChild(layer);
	return scene;
}

BJK8ChaseNumBerLayer::BJK8ChaseNumBerLayer()
{
	fandianStatus = 0;
	ZhuiHaoBool =0;
	BeiTouBool = 0;
	...
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(BJK8ChaseNumBerLayer::TouZhuZhuiHaoButton), "TouZhuChaseNumBer", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(BJK8ChaseNumBerLayer::changeKind), "GDselectedItemTagNumberCartFailed", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(BJK8ChaseNumBerLayer::touZhuContinueRet), "CQSSCRetZhuiHao", NULL);

	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(BJK8ChaseNumBerLayer::IsFendanHourRet), "IsFendanHourRet", NULL);
}
BJK8ChaseNumBerLayer::~BJK8ChaseNumBerLayer()
{
...
bool BJK8ChaseNumBerLayer::init()
{
	if (!Layer::init())
	{
		return false;
...
void BJK8ChaseNumBerLayer::initData()
{
	winSize = Director::getInstance()->getWinSize();
		//gameKyTe = NULL;
}

void BJK8ChaseNumBerLayer::initView()
{
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(BJK8ChaseNumBerLayer::back,this));
	...
	ButtonCodeRecordItem = MenuItemSprite::create(ButtonCodedImage,ButtonCodeNormalImage,CC_CALLBACK_1(BJK8ChaseNumBerLayer::XuanZeZhuiHaoQiShu,this));
	...
	betRecordItem = MenuItemSprite::create(winningRecordSelectedImage,contiRecordNormalImage,CC_CALLBACK_1(BJK8ChaseNumBerLayer::IsEndeBeiTou,this));
	...
	GetRecordItem = MenuItemSprite::create(betRecordNormalImage,betRecordSelectedImage,CC_CALLBACK_1(BJK8ChaseNumBerLayer::IsEndeZhuiHao,this));
	...
	StramItem = MenuItemSprite::create(StramNormalImage_1,StramNormalImage_2,CC_CALLBACK_1(BJK8ChaseNumBerLayer::betRecord,this));
	CloseItem = MenuItemSprite::create(CloseNormalImage_1,CloseNormalImage_2,CC_CALLBACK_1(BJK8ChaseNumBerLayer::ZhuiHaoCloseButton,this));
...
//top menu
void BJK8ChaseNumBerLayer::setting(Object* obj)
{
	playButtonSound();
...
void BJK8ChaseNumBerLayer::back(Object *obj)
{
	playButtonSound();
...
//transaction menu
void BJK8ChaseNumBerLayer::recharge(Object* obj)
{

}

void BJK8ChaseNumBerLayer::withdraw(Object *obj)
{

}
void BJK8ChaseNumBerLayer::ZhuiHaoCloseButton(Object *obj)
{
	this->setPositionY(2000);
	NotificationCenter::getInstance()->postNotification("ChaseNumBerItem");
}
...
void BJK8ChaseNumBerLayer::dissZhuiHaoMen()
{
...
void BJK8ChaseNumBerLayer::TouZhuZhuiHaoButton(Object *obj)
{
...
void BJK8ChaseNumBerLayer::betRecord(Object *obj)
{
	playButtonSound();
...
void BJK8ChaseNumBerLayer::IsFendanHourRet(Object *obj)
{
	...
	for(int id = 0;id < MyBetNumber::getInstance()->size();id ++)
	{
		...
		EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC_ZhioHao(zhuiHaoQiShu, qiShu, tempInfo.m_gameKind->getValue(), BetLimit::GetWanfaIdFromId(tempInfo.m_wanFaKind->getValue(),5),
...
void BJK8ChaseNumBerLayer::touZhuContinueRet(Object *obj)
{
...
void BJK8ChaseNumBerLayer::ZhuiHaoQiShuRecord(Object *obj)
{
}

void BJK8ChaseNumBerLayer::contiRecord(Object *obj)
{
}

void BJK8ChaseNumBerLayer::onEnter()
{
	Layer::onEnter();
}

void BJK8ChaseNumBerLayer::onExit()
{
	Layer::onExit();
}

void BJK8ChaseNumBerLayer::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
cocos2d::Size BJK8ChaseNumBerLayer::cellSizeForTable(TableView *table)
{
	cocos2d::Size size;
...
ssize_t BJK8ChaseNumBerLayer::numberOfCellsInTableView(TableView *table)
{
	int tag = dynamic_cast<Node*>(table)->getTag();
...
TableViewCell *BJK8ChaseNumBerLayer::tableCellAtIndex(TableView *table,ssize_t index)
{
	...
	if(tag == 1111){
		...
		XuanZeQiShuItem = MenuItemSprite::create(XuanZeQiShuNormalImage,XuanZeQiShuSelectedImage,CC_CALLBACK_1(BJK8ChaseNumBerLayer::XuanZeQiShu,this));
...
void BJK8ChaseNumBerLayer::tableCellTouched(TableView *table, TableViewCell *cell)
{
...
void BJK8ChaseNumBerLayer::scrollViewDidScroll(ScrollView* view)
{

}
void BJK8ChaseNumBerLayer::scrollViewDidZoom(ScrollView* view)
{

}
void BJK8ChaseNumBerLayer::XuanZeQiShu(Object *obj)
{
	playButtonSound();
...
void BJK8ChaseNumBerLayer::XuanZeZhuiHaoQiShu(Object *obj)
{
	playButtonSound();
...
void BJK8ChaseNumBerLayer::IsEndeBeiTou(Object *obj)
{
	playButtonSound();
...
void BJK8ChaseNumBerLayer::IsEndeZhuiHao(Object *obj)
{
	playButtonSound();
...
void BJK8ChaseNumBerLayer::editBoxEditingDidEnd(EditBox* editBox)
{
	string nMoshiString = CtratebeilvInput->getText();
	int nBeiShu = atoi(nMoshiString.c_str());

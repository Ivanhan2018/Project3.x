...
//个人用户中心
Scene* LotteryActiveCenterEx::scene()
{
...
LotteryActiveCenterEx::LotteryActiveCenterEx()
{
	//EntityMgr::instance()->getDispatch()->SendPacketWithGetUserInfo();
	//NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryActiveCenterEx::getLastYueRet), "GetLastYueRet", NULL);  ///余额查询
	//NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryActiveCenterEx::zhuanHuanRet), "ZhuanHuanRet", NULL);
	//NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryActiveCenterEx::exitReturn), "ExitReturn", NULL); //退出
	//NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryActiveCenterEx::getKeFuUrl), "GetKeFuUrl", NULL);
	//NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(LotteryActiveCenterEx::getActiveRet), "GetActiveRet", NULL);
	m_list = nullptr;
}
LotteryActiveCenterEx::~LotteryActiveCenterEx()
{
...
bool LotteryActiveCenterEx::init()
{
	if (!Layer::init())
	{
		return false;
...
void LotteryActiveCenterEx::initData()
{
	winSize = Director::getInstance()->getWinSize();
}

void LotteryActiveCenterEx::initView()
{
	...
	(pCloseNormalButton, pCloseSelectButton, CC_CALLBACK_1(LotteryActiveCenterEx::back, this));
...
void LotteryActiveCenterEx::onEnter()
{
	BaseLayer::onEnter();
}

void LotteryActiveCenterEx::onExit()
{
	BaseLayer::onExit();
}

void LotteryActiveCenterEx::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
void LotteryActiveCenterEx::back(Object *obj)
{
	playButtonSound();
	//Scene *scene = Scene::create();
...
cocos2d::Size LotteryActiveCenterEx::cellSizeForTable(TableView *table)
{
	cocos2d::Size size;
...
ssize_t LotteryActiveCenterEx::numberOfCellsInTableView(TableView *table)
{
#ifdef VER_369
...
TableViewCell *LotteryActiveCenterEx::tableCellAtIndex(TableView *table,ssize_t index)
{
...
void LotteryActiveCenterEx::tableCellTouched(TableView *table, TableViewCell *cell)
{
	...
	case 1: //1 是签到 2 是 欢乐送 3佣金大回馈 4充值送
	{
		...
		//::instance()->getDispatch()->SendPacketWithGetUserInfo();
		clear();
		break;
	}
...
void LotteryActiveCenterEx::scrollViewDidScroll(ScrollView* view)
{

}
void LotteryActiveCenterEx::scrollViewDidZoom(ScrollView* view)
{

}

void LotteryActiveCenterEx::getActiveRet(Object* obj)
{
	if (m_list != nullptr)
	{
		m_list = nullptr;
...
void LotteryActiveCenterEx::getActiveRetEx()
{
...
int LotteryActiveCenterEx::getIdFromText(const char* name)
{
...
void LotteryActiveCenterEx::loginOut(Object *obj)
{
	playButtonSound();
...
void LotteryActiveCenterEx::clear()
{

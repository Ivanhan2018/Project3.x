...
Scene* ChongQingChaseNumBerLayer::scene()
{
	Scene *scene = Scene::create();
	ChongQingChaseNumBerLayer *layer = ChongQingChaseNumBerLayer::create();
	scene->addChild(layer);
	return scene;
}

ChongQingChaseNumBerLayer::ChongQingChaseNumBerLayer()
{
	fandianStatus = 0;
	ZhuiHaoBool =0;
	BeiTouBool = 0;
	...
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(ChongQingChaseNumBerLayer::TouZhuZhuiHaoButton), "TouZhuChaseNumBer", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(ChongQingChaseNumBerLayer::changeKind), "GDselectedItemTagNumberCartFailed", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(ChongQingChaseNumBerLayer::touZhuContinueRet), "CQSSCRetZhuiHao", NULL);

	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(ChongQingChaseNumBerLayer::IsFendanHourRet), "IsFendanHourRet", NULL);
}
ChongQingChaseNumBerLayer::~ChongQingChaseNumBerLayer()
{
...
bool ChongQingChaseNumBerLayer::init()
{
	if (!Layer::init())
	{
		return false;
...
void ChongQingChaseNumBerLayer::initData()
{
	winSize = Director::getInstance()->getWinSize();
		//gameKyTe = NULL;
}

void ChongQingChaseNumBerLayer::initView()
{
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(ChongQingChaseNumBerLayer::back,this));
	...
	ButtonCodeRecordItem = MenuItemSprite::create(ButtonCodedImage,ButtonCodeNormalImage,CC_CALLBACK_1(ChongQingChaseNumBerLayer::XuanZeZhuiHaoQiShu,this));
	...
	betRecordItem = MenuItemSprite::create(winningRecordSelectedImage,contiRecordNormalImage,CC_CALLBACK_1(ChongQingChaseNumBerLayer::IsEndeBeiTou,this));
	...
	GetRecordItem = MenuItemSprite::create(betRecordNormalImage,betRecordSelectedImage,CC_CALLBACK_1(ChongQingChaseNumBerLayer::IsEndeZhuiHao,this));
	...
	StramItem = MenuItemSprite::create(StramNormalImage_1,StramNormalImage_2,CC_CALLBACK_1(ChongQingChaseNumBerLayer::betRecord,this));
	CloseItem = MenuItemSprite::create(CloseNormalImage_1,CloseNormalImage_2,CC_CALLBACK_1(ChongQingChaseNumBerLayer::ZhuiHaoCloseButton,this));
...
//top menu
void ChongQingChaseNumBerLayer::setting(Object* obj)
{
	playButtonSound();
...
void ChongQingChaseNumBerLayer::back(Object *obj)
{
	playButtonSound();
...
//transaction menu
void ChongQingChaseNumBerLayer::recharge(Object* obj)
{

}

void ChongQingChaseNumBerLayer::withdraw(Object *obj)
{

}
void ChongQingChaseNumBerLayer::ZhuiHaoCloseButton(Object *obj)
{
	this->setPositionY(2000);
	NotificationCenter::getInstance()->postNotification("ChaseNumBerItem");
}
...
//record menu
void ChongQingChaseNumBerLayer::changeKind(Object *obj)
{
	String *GDselectQiShuString = (String *)obj;
	GDselectedItemTagNumber = atof(GDselectQiShuString->getCString());
	//touZhuTable->reloadData();
}
void ChongQingChaseNumBerLayer::ShowZhuiHaoMen()
{
...
void ChongQingChaseNumBerLayer::dissZhuiHaoMen()
{
...
void ChongQingChaseNumBerLayer::TouZhuZhuiHaoButton(Object *obj)
{
...
void ChongQingChaseNumBerLayer::betRecord(Object *obj)
{
	playButtonSound();
...
void ChongQingChaseNumBerLayer::touZhuContinueRet(Object *obj)
{
...
void ChongQingChaseNumBerLayer::ZhuiHaoQiShuRecord(Object *obj)
{

}

void ChongQingChaseNumBerLayer::IsFendanHourRet(Object *obj)
{
	...
	for(int id = 0;id < MyBetNumber::getInstance()->size();id ++)
	{
		...
		EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC_ZhioHao(zhuiHaoQiShu, qiShu, tempInfo.m_gameKind->getValue(), BetLimit::GetWanfaIdFromId(tempInfo.m_wanFaKind->getValue(),0),
			tempInfo.m_betNumber->getCString(), tempInfo.m_betCount->getValue(), beiShu, tempInfo.m_mode->getValue(), nbeiShu, 0, ZhuiHao, 0);

	}

	this->setPositionY(2000);
	NotificationCenter::getInstance()->postNotification("ZhuiHaobackCHongQIN");
	NotificationCenter::getInstance()->postNotification("ZhuiHaoTouZhuJinENumber",Float::create(TouZhuJinE));
}

void ChongQingChaseNumBerLayer::contiRecord(Object *obj)
{
}

void ChongQingChaseNumBerLayer::onEnter()
{
	Layer::onEnter();
}

void ChongQingChaseNumBerLayer::onExit()
{
	Layer::onExit();
}

void ChongQingChaseNumBerLayer::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
cocos2d::Size ChongQingChaseNumBerLayer::cellSizeForTable(TableView *table)
{
	cocos2d::Size size;
...
ssize_t ChongQingChaseNumBerLayer::numberOfCellsInTableView(TableView *table)
{
	int tag = dynamic_cast<Node*>(table)->getTag();
...
TableViewCell *ChongQingChaseNumBerLayer::tableCellAtIndex(TableView *table,ssize_t index)
{
	...
	if(tag == 1111){
		...
		XuanZeQiShuItem = MenuItemSprite::create(XuanZeQiShuNormalImage,XuanZeQiShuSelectedImage,CC_CALLBACK_1(ChongQingChaseNumBerLayer::XuanZeQiShu,this));
...
void ChongQingChaseNumBerLayer::tableCellTouched(TableView *table, TableViewCell *cell)
{
...
void ChongQingChaseNumBerLayer::scrollViewDidScroll(ScrollView* view)
{

}
void ChongQingChaseNumBerLayer::scrollViewDidZoom(ScrollView* view)
{

}
void ChongQingChaseNumBerLayer::XuanZeQiShu(Object *obj)
{
...
void ChongQingChaseNumBerLayer::XuanZeZhuiHaoQiShu(Object *obj)
{
	playButtonSound();
...
void ChongQingChaseNumBerLayer::IsEndeBeiTou(Object *obj)
{
	playButtonSound();
...
void ChongQingChaseNumBerLayer::IsEndeZhuiHao(Object *obj)
{
	playButtonSound();
...
void ChongQingChaseNumBerLayer::editBoxEditingDidEnd(EditBox* editBox)
{
	string nMoshiString = CtratebeilvInput->getText();
	int nBeiShu = atoi(nMoshiString.c_str());

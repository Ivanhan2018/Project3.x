#ifndef __GAMBLELAYER_H__
#define __GAMBLELAYER_H__
...
class ChongQingGambleLayer : public BaseLayer, public EditBoxDelegate,public TableViewDelegate,
	public TableViewDataSource
{
public:
	ChongQingGambleLayer();
	~ChongQingGambleLayer();
	CREATE_FUNC(ChongQingGambleLayer);
	virtual bool init();
	static Scene* scene();
	...
	void refreshLayer();
private:
	void setWanFaKind(SSCWanFaKind kind);
	void initData();
	void initView();	
	...
	ChongQingBetArea *betArea;
	
	SSCWanFaKind wanFaKind;
	int selectedItemTag;
	float TouZhuJinE;
	float ZhangHuYuE;
	...
	ChongQingKindScrollView *kindLayer;
	...
	void HgydwfcDelta(Object *obj);
	void CanadaSDWFQiHao(Object *obj);

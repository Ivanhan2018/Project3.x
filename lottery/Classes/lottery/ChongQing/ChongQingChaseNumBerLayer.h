#ifndef _ChongQingChaseNumBerLayer_H
#define _ChongQingChaseNumBerLayer_H
...
class ChongQingChaseNumBerLayer : public Layer, public TableViewDelegate,
	public TableViewDataSource, public EditBoxDelegate
{
public:
	ChongQingChaseNumBerLayer();
	~ChongQingChaseNumBerLayer();
	CREATE_FUNC(ChongQingChaseNumBerLayer);
	virtual bool init();
	static Scene* scene();
...
private:
	...
	long long GDselectedItemTagNumber;  //当前期数
...
#endif // __ChongQingChaseNumBerLayer_H__
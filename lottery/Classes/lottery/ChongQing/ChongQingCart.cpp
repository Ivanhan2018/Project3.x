...
Scene* ChongQingCart::scene()
{
	Scene *scene = Scene::create();
	ChongQingCart *layer = ChongQingCart::create();
	scene->addChild(layer);
	return scene;
}
ChongQingCart::ChongQingCart()
{
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(ChongQingCart::ZhuiHaoback), "ZhuiHaobackCHongQIN", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(ChongQingCart::SetusedBonusRet), "SetusedBonusRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(ChongQingCart::pressChaseNumShow), "ChaseNumBerItem", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(ChongQingCart::RemoveCurrentLayer), "RemoveCurrentLayer", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(ChongQingCart::RefreshData), "RefreshData", NULL);
}
ChongQingCart::~ChongQingCart()
{	
...
bool ChongQingCart::init()
{
	...
	listener->onTouchBegan = CC_CALLBACK_2(ChongQingCart::onTouchBegan,this);
	listener->onTouchEnded = CC_CALLBACK_2(ChongQingCart::onTouchEnded,this);
	listener->onTouchMoved = CC_CALLBACK_2(ChongQingCart::onTouchMoved,this);
...
void ChongQingCart::initView()
{
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(ChongQingCart::back,this));
	...
	confirmItem = MenuItemSprite::create(confirmNormalImage,confirmSelectedImage,CC_CALLBACK_1(ChongQingCart::confirm,this));
	MenuItemSprite *ZhuiHaoItem = MenuItemSprite::create(ZhuiHaoNormalImage,ZhuiHaoSelectedImage,CC_CALLBACK_1(ChongQingCart::ZhuiHaoItemMinusobj,this));
	...
	MenuItemSprite *addRandomItem = MenuItemSprite::create(addRandomNormalImage,addRandomSelectedImage,CC_CALLBACK_1(ChongQingCart::deleRandom,this));
	...
	ZhuiHao11Xuan5Cart = ChongQingChaseNumBerLayer::create();
...
void ChongQingCart::updateBetInfo()
{	
	int totalZhuShu = 0;
	float totalMoney = 0;
...
//追号
void ChongQingCart::ZhuiHaoItemMinusobj(Object *obj)
{
	playButtonSound();
...
void ChongQingCart::pressChaseNumShow(Object *obj)
{
	ShowIsChaseNum();
	this->setKeypadEnabled(true);
}
void ChongQingCart::SetusedBonusRet(Object *obj)
{
...
void ChongQingCart::ZhuiHaoback(Object *obj)
{
	playButtonSound();
	this->setPositionY(2000);
}

void ChongQingCart::back(Object *obj)
{
	playButtonSound();
	this->setPositionY(2000);
...
void ChongQingCart::ShowIsChaseNum()
{
...
void ChongQingCart::dissisChaseNum()
{
...
//transaction menu
void ChongQingCart::confirm(Object* obj)
{
	playButtonSound();
...
void ChongQingCart::bottomMenuEnabled(bool GuangDong11Xuan5BoolSuccen)
{
...
void ChongQingCart::deleRandom(Object* obj)
{
	playButtonSound();
...
void ChongQingCart::onEnter()
{
	Layer::onEnter();

}

void ChongQingCart::onExit()
{
	Layer::onExit();
}

void ChongQingCart::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
cocos2d::Size ChongQingCart::cellSizeForTable(TableView *table)
{
	cocos2d::Size size;
...
ssize_t ChongQingCart::numberOfCellsInTableView(TableView *table)
{
	return MyBetNumber::getInstance()->size() + 1;

}
TableViewCell *ChongQingCart::tableCellAtIndex(TableView *table,ssize_t index)
{
	...
	if(wanFanKind->getValue() == Ren3Hunhe_Zuxuan || wanFanKind->getValue() == Ren2Zuxuan_Fushi || wanFanKind->getValue() == Ren2Zuxuan_Fushi || wanFanKind->getValue() == Ren3Zu3_Fushi || wanFanKind->getValue() == Ren3Zu6_Fushi)
	{
		result = BetLimit::GetGSBQWStr(result.c_str());
	}
	//游戏名称
...
void ChongQingCart::tableCellTouched(TableView *table, TableViewCell *cell)
{
...
void ChongQingCart::scrollViewDidScroll(ScrollView* view)
{

}
void ChongQingCart::scrollViewDidZoom(ScrollView* view)
{

}

bool ChongQingCart::onTouchBegan(Touch *pTouch, Event *pEvent)
{
...
void ChongQingCart::onTouchMoved(Touch *pTouch, Event *pEvent)
{

}

void ChongQingCart::onTouchEnded(Touch *pTouch, Event *pEvent)
{	
	Vec2 pos = Director::getInstance()->convertToGL(pTouch->getLocationInView());
	endPoint = pos;
...
void ChongQingCart::pressDeleteButton(int index)
{
	NotificationCenter::getInstance()->postNotification("DeleteItem", Integer::create(index));
}

void ChongQingCart::RemoveCurrentLayer(Object *obj)
{
	this->setPositionY(2000);
	this->ShowIsChaseNum();	
}

void ChongQingCart::RefreshData(Object *obj)
{

...
Scene* GuangDong11Xuan5Layer::scene()
{
...
GuangDong11Xuan5Layer::GuangDong11Xuan5Layer()
{
	addRandSeedGuangDong();
	wKindID = NULL;
	wPeriod = NULL;
	szLotNum = NULL;
	szShijian = NULL;
	gameRule = NULL;
	gameKind = CZGD11Xuan5;
	nLMoshi =0;
	...
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::GetLastYueRet), "GetLastYueRet", NULL);  ///余额查询
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::ShiShiCaiNumber), "ShiShiCaiNumber", NULL);  ///追号所花费的金额
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::ZhuiHaoTouZhuJinENumber), "ZhuiHaoTouZhuJinENumber", NULL);  ///追号所花费的金额
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::queryGameRet), "QueryGameRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::touZhuRet), "CQSSCRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::changeKind), "CQSSCChangeKind", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::deleteItem), "DeleteItem", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::addRandomItem), "AddRandomItem", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::cartConfirm), "CartConfirm", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::clearNumbers), "ClearNumbers", NULL);
	//NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::getSystemTimeObject), "GetSystemTimeRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::updateTouZhuJine), "UpdateTouZhuJine", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::KindMyFanDianRet), "QueryMyFanDianRet", NULL);

	//追号验证
	NotificationCenter::getInstance()->addObserver(this,callfuncO_selector(GuangDong11Xuan5Layer::isFenDanHour), "IsFendanHour", NULL);

	//跨年期号处理
	NotificationCenter::getInstance()->addObserver(this,callfuncO_selector(GuangDong11Xuan5Layer::kuaNianExpect), "KuaNian", NULL);

	//结果查询
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Layer::queryGameMoreRet), "QueryMoreGameRet", NULL);
}

void GuangDong11Xuan5Layer::getSystemTime(float dt)
{
...
GuangDong11Xuan5Layer::~GuangDong11Xuan5Layer()
{
	...
	NotificationCenter::getInstance()->removeObserver(this, "ShiShiCaiNumber");
	...
	this->unschedule(schedule_selector(GuangDong11Xuan5Layer::updatePeriod));
	this->unschedule(schedule_selector(GuangDong11Xuan5Layer::getSystemTime));
	this->unschedule(schedule_selector(GuangDong11Xuan5Layer::myUpdate));
...
void GuangDong11Xuan5Layer::updatePeriod(float dt)
{
	EntityMgr::instance()->getDispatch()->SendPacketQueryGameResult(gameKind);
}

void GuangDong11Xuan5Layer::refreshLayer()
{
	//更新期号
	EntityMgr::instance()->getDispatch()->SendPacketQueryGameResult(gameKind);
	//更新余额
	...
	//更新奖金
	EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC_FanDian(gameKind, BetLimit::GetWanfaIdFromId(wanFaKind,1));
...
void GuangDong11Xuan5Layer::setWanFaKind(tagEnumIIXuan5 kind)
{
	wanFaKind = kind;
	...
	betArea = GuangDong11Xuan5WuFen::create();
...
bool GuangDong11Xuan5Layer::init()
{
	if (!Layer::init())
	{
		return false;
...
void GuangDong11Xuan5Layer::myUpdate(float dt)
{
...
void GuangDong11Xuan5Layer::getSystemTimeObject(Object *obj)
{
...
void GuangDong11Xuan5Layer::initData()
{
	wanFaKind = QianYi;
...
void GuangDong11Xuan5Layer::initView()
{
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(GuangDong11Xuan5Layer::back,this));
	...
	MenuItemSprite *setupItem = MenuItemSprite::create(setupItemNormalImage,setupItemSelectedImage,CC_CALLBACK_1(GuangDong11Xuan5Layer::setting,this));
	...
	//MenuItemLabel *lbItem = MenuItemLabel::create(moreItemLabel,CC_CALLBACK_1(GuangDong11Xuan5Layer::jumpResult,this));
	...
	MenuItemSprite *deleteItem = MenuItemSprite::create(deleteNormalImage,deleteSelectedImage,CC_CALLBACK_1(GuangDong11Xuan5Layer::toDelete,this));
	MenuItemSprite *randomGambleItem = MenuItemSprite::create(randomNormalImage,randomSelectedImage,CC_CALLBACK_1(GuangDong11Xuan5Layer::toRandomGamble,this));
	...
	moreItem = MenuItemSprite::create(moreNormalImage2,moreSelectedImage2,CC_CALLBACK_1(GuangDong11Xuan5Layer::toMore,this));
	...
	MenuItemSprite *beiAddItem = MenuItemSprite::create(beiAdd,beiAddPress,CC_CALLBACK_1(GuangDong11Xuan5Layer::beiAdd,this));
	MenuItemSprite *beiMinusItem = MenuItemSprite::create(beiMinus,beiMinusPress,CC_CALLBACK_1(GuangDong11Xuan5Layer::beiMinus,this));
	...
	MenuItemSprite *FanDianSelectedImage = MenuItemSprite::create(FanDianSprite_1,FanDianSprite_2,CC_CALLBACK_1(GuangDong11Xuan5Layer::FanDianMinus,this));
	...
	cartItem = MenuItemSprite::create(cartNormalImage,cartSelectedImage,CC_CALLBACK_1(GuangDong11Xuan5Layer::toGamble,this));
	MenuItemSprite *confirmItem = MenuItemSprite::create(confirmNormalImage,confirmSelectedImage,CC_CALLBACK_1(GuangDong11Xuan5Layer::toCart,this));
	...
	YuanSelectedImageLayer = MenuItemSprite::create(YuanSprite_1,YuanSprite_2,YuanSprite_3,CC_CALLBACK_1(GuangDong11Xuan5Layer::XuanZeMonenyLayer,this));
	YuanSelectedImageLayer->setTag(YuanShiShiCAITag);
	JiaoSelectedImageLayer = MenuItemSprite::create(JiaoSprite_1,JiaoSprite_2,JiaoSprite_3,CC_CALLBACK_1(GuangDong11Xuan5Layer::XuanZeMonenyLayer,this));
	JiaoSelectedImageLayer->setTag(JiaoShiShiCAITag);
	FenSelectedImageLayer = MenuItemSprite::create(FenSprite_1,FenSprite_2,FenSprite_3,CC_CALLBACK_1(GuangDong11Xuan5Layer::XuanZeMonenyLayer,this));
	FenSelectedImageLayer->setTag(FenShiShiCAITag);
	//新增厘模式
	LiSelectedImageLayer = MenuItemSprite::create(LiSprite_1, LiSprite_2, LiSprite_3,CC_CALLBACK_1(GuangDong11Xuan5Layer::XuanZeMonenyLayer, this));
	...
	cart = GuangDong11Xuan5Cart::create();
...
void GuangDong11Xuan5Layer::queryGameRet(Object *obj)
{
...
void GuangDong11Xuan5Layer::updateLotteryId()
{
...
void GuangDong11Xuan5Layer::updateCurrentTime()
{
	String *headStr = NULL;
...
void GuangDong11Xuan5Layer::touZhuRet(Object *obj)
{
...
//top menu
void GuangDong11Xuan5Layer::setting(Object* obj)
{
	playButtonSound();
...
void GuangDong11Xuan5Layer::jumpResult(Object* obj)
{	
	playButtonSound();	
...
void GuangDong11Xuan5Layer::XuanZeMonenyLayer(Object *obj)
{
	//playButtonSound();
...
//middle menu
void GuangDong11Xuan5Layer::toMore(Object* obj)
{
	playButtonSound();
...
void GuangDong11Xuan5Layer::toRandomGamble(Object* obj)
{
	playButtonSound();
...
void GuangDong11Xuan5Layer::ShiShiCaiNumber(Object *obj)
{
...
//bottom menu
void GuangDong11Xuan5Layer::toDelete(Object* obj)
{
	playButtonSound();
	if(betArea != NULL)
	{
...
void GuangDong11Xuan5Layer::toCart(Object* obj)
{
	playButtonSound();
	...
	if(!bRet)
	{
		...
		if(strcmp(betNumber->getCString(), "") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t184"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
			//任选两至少选择两个号码
		}else if(strcmp(betNumber->getCString(), "//") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t185"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "///") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t186"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "IV") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t187"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "V") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t188"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "VI") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t189"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "VII") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t190"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "VIII") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t191"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "QY") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t192"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "QR") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t185"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
		...
		}else if(strcmp(betNumber->getCString(), "==") == 0)
		{
			...
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "SAN") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t193"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "SANZU") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t194"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "ERZHI") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t195"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}else if(strcmp(betNumber->getCString(), "ERZU") == 0)
		{
			MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(ConfigMgr::instance()->text("display_DuangDong.xml", "t196"),
				Vec2(winSize.width * 0.5,winSize.height * 0.5));
			this->addChild(layer, 255);
			return;
		}		
		...
		//判断注数限制
		int maxCount = BetLimit::GetMaxBetFromId(gameKind,BetLimit::GetWanfaIdFromId(wanFaKind,1));
		int nowTouzhu = betZhuShuTouZhuJinE;
		if(maxCount < nowTouzhu)
		{
			std::string strDisplay =
				BetLimit::GetWanFaNameFromId(gameKind,BetLimit::GetWanfaIdFromId(wanFaKind,1)) +
		...
		if(!BetLimit::CheckDingWeiDanStr(BetLimit::GetWanfaIdFromId(wanFaKind,1),betNumber->getCString()))
		{
		...
		Integer* b_wanFaKind = Integer::create(BetLimit::GetWanfaIdFromId(wanFaKind,1));
...
void GuangDong11Xuan5Layer::toGamble(Object* obj)
{
	playButtonSound();
	...
	if(!bRet)
	{
		...
		char tempStr[20] = {0};
#if (CC_TARGET_PLATFORM == CC_PLATFORM_WIN32)
		sprintf(tempStr, "%I64d", qishu);
#else
		sprintf(tempStr, "%lld", qishu);
#endif
		string qishuStr = string(tempStr);
		EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC(qishuStr, gameKind, BetLimit::GetWanfaIdFromId(wanFaKind, 1),
...
void GuangDong11Xuan5Layer::changeKind(Object *obj)
{
	selectedItemTag = ((Integer *)obj)->getValue(); 
	//保存
	MyBetData::getInstance()->setLastWanfaId(GuangDongwanFaMap[selectedItemTag]);
	//
	...
	this->setWanFaKind(GuangDongwanFaMap[selectedItemTag]);
	betArea->clearNumbers();
	betArea->cancelAllMenuSelect();
	betZhuShuTouZhuJinE = 0;
...
void GuangDong11Xuan5Layer::onEnter()
{
	BaseLayer::onEnter();
}

void GuangDong11Xuan5Layer::onExit()
{
	BaseLayer::onExit();
}

void GuangDong11Xuan5Layer::back(Object *obj)
{
	playButtonSound();
...
void GuangDong11Xuan5Layer::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
void GuangDong11Xuan5Layer::showKindView()
{
	...
	//彩种下拉框选择
	kindLayer = GuangDong11Xuan5KindScrollView::create();
...
void GuangDong11Xuan5Layer::hideKindView()
{
	LayerColor* layer = (LayerColor *)this->getChildByTag(9527);
	if(layer == nullptr) return;
...
void GuangDong11Xuan5Layer::isCartShow()
{
	MonenyMenuLayer->setEnabled(true);
}
void GuangDong11Xuan5Layer::isCartdiss()
{

	MonenyMenuLayer->setEnabled(false);
}
void GuangDong11Xuan5Layer::isCartShowXuan5Layer(Object *obj)
{
	this->isCartShow();
}
void GuangDong11Xuan5Layer::ZhuiHaoTouZhuJinENumber(Object *obj)
{
...
void GuangDong11Xuan5Layer::addRandomItem(Object *obj)
{
	isCartShow();
	this->setKeypadEnabled(true);
	betZhuShuTouZhuJinE = 0.00;
...
void GuangDong11Xuan5Layer::cartConfirm(Object *obj)
{
...
void GuangDong11Xuan5Layer::clearNumbers(Object *obj)
{
	 MyBetNumber::getInstance()->clear();
...
void GuangDong11Xuan5Layer::deleteItem(Object *obj)
{
...
void GuangDong11Xuan5Layer::setGameKind(CaiZhong kind)
{
	//初始化数据
	MyBetData::getInstance()->setCurCaiZhongId(kind);

	int last = MyBetData::getInstance()->getLastWanfaId();
	if(last == -1) last = GuangDongwanFaMap[1];

	this->setWanFaKind((IIXuan5GameKind)last);
	selectedItemTag = 1;

	for(int i = 0;i < MyBetData::getInstance()->getWanfaSize();i ++)
	{
		if(GuangDongwanFaMap[MyBetData::getInstance()->getWanfaAt(i)] == last)
		{
	...
	EntityMgr::instance()->getDispatch()->SendPacketQueryGameResult(gameKind);
	this->schedule(schedule_selector(GuangDong11Xuan5Layer::updatePeriod), 3);

	//跨年处理
#if 1
	EntityMgr::instance()->getDispatch()->SendPacketWithGetKuaNianQiHao(gameKind);
	this->schedule(schedule_selector(GuangDong11Xuan5Layer::getSystemTime), 3);
#endif
	this->schedule(schedule_selector(GuangDong11Xuan5Layer::myUpdate), 1);

	gameTitle->setString(ConfigMgr::instance()->text("display_config.xml",String::createWithFormat("t%d", 20+gameKind)->getCString()));
	if(gameRule == NULL){
		if(gameKind == CZGD11Xuan5)
		{
...
void GuangDong11Xuan5Layer::updateTouZhuJine(Object *obj)
{
	betArea->getBetNumber();
	betZhuShuTouZhuJinE = betArea->getBetZhuShu();
...
void GuangDong11Xuan5Layer::GetLastYueRet(Object *obj)
{
...
//------------------------------------------------新增----------------------------------------------------------------
void GuangDong11Xuan5Layer::editBoxEditingDidEnd(EditBox* editBox)
{
...
void GuangDong11Xuan5Layer::FanDianMinus(Object *obj)
{
	playButtonSound();
	...
	listener->onTouchBegan = CC_CALLBACK_2(GuangDong11Xuan5Layer::onTouchBegan,this);
	listener->onTouchEnded = CC_CALLBACK_2(GuangDong11Xuan5Layer::onTouchEnded,this);
	listener->onTouchMoved = CC_CALLBACK_2(GuangDong11Xuan5Layer::onTouchMoved,this);
	...
	MenuItemSprite* MakeSureMenuItem = MenuItemSprite::create(MakeSureSprite_1,MakeSureSprite_2,CC_CALLBACK_1(GuangDong11Xuan5Layer::SuccenGameResume,this));
	MenuItemSprite* PCloseItemMenuItem = MenuItemSprite::create(PCloseItem_1,PCloseItem_2,CC_CALLBACK_1(GuangDong11Xuan5Layer::pCoseGameResume,this));
	...
	MenuItemSprite* MinusMenuItem = MenuItemSprite::create(MinusValueSprite_1,MinusValueSprite_2,CC_CALLBACK_1(GuangDong11Xuan5Layer::PlusFianDian,this));
	MinusMenuItem->setAnchorPoint(Vec2(0.5,0.5));
	MinusMenuItem->setPosition(Vec2(winSize.width*0.84 + 10,winSize.height*0.5 + tempInt));
	MenuItemSprite* PlusMenuItem = MenuItemSprite::create(PlusValueSprite_1,PlusValueSprite_2,CC_CALLBACK_1(GuangDong11Xuan5Layer::MinusFanDian,this));
...
void GuangDong11Xuan5Layer::PlusFianDian(Object *obj)
{
...
void GuangDong11Xuan5Layer::MinusFanDian(Object *obj)
{
	float PlusFanDianvalie =PlusFanDianvalieMAX;
...
void GuangDong11Xuan5Layer::pCoseGameResume(Object *obj)
{
...
void GuangDong11Xuan5Layer::SuccenGameResume(Object *obj)
{
	this->removeChild(layerColor, true);
	char str[33];
	char str2[33];
	...
	if(!bRet)
	{
		...
		EntityMgr::instance()->getDispatch()->SendPacketWithGetTouZhuSetUserBonus(gameKind, BetLimit::GetWanfaIdFromId(wanFaKind,1), PlusFanDianvalieMAX, BaiFenbiNumber);
	}
}

/**触摸开始*/
bool GuangDong11Xuan5Layer::onTouchBegan(Touch *pTouch, Event *pEvent)
{	
...
void GuangDong11Xuan5Layer::onTouchMoved(Touch *pTouch, Event *pEvent)
{

}

void GuangDong11Xuan5Layer::onTouchEnded(Touch *pTouch, Event *pEvent)
{	

}

void GuangDong11Xuan5Layer::KindMyFanDianRet(Object *obj)
{
	...
	int count = data->count();
	if (count == 0) return;
	int myWanFa = BetLimit::GetWanfaIdFromId(wanFaKind,1);
	for (int i = 0;i < count; i += 4)
	{
		Integer *id = (Integer*) data->objectAtIndex(i);
...
void GuangDong11Xuan5Layer::isFenDanHour(Object *obj)
{
	NotificationCenter::getInstance()->postNotification("IsFendanHourRet", Bool::create(m_bIsFendan));
}

void GuangDong11Xuan5Layer::kuaNianExpect(Object *obj)
{
	Dictionary* data = (Dictionary *)obj;
...
void GuangDong11Xuan5Layer::pressMinus(Object *obj)
{
...
void GuangDong11Xuan5Layer::beiAdd(Object *obj)
{
	playButtonSound();
...
void GuangDong11Xuan5Layer::beiMinus(Object *obj)
{
	playButtonSound();
...
void GuangDong11Xuan5Layer::updateMoneyLabel()
{
...
void GuangDong11Xuan5Layer::tableCellTouched(TableView* table, TableViewCell* cell)
{
...
cocos2d::Size GuangDong11Xuan5Layer::cellSizeForTable(TableView *table)
{
	cocos2d::Size result;
...
TableViewCell* GuangDong11Xuan5Layer::tableCellAtIndex(TableView *table, ssize_t idx)
{
	...
	if(table->getTag() == 1000) //菜单
	{
		...
		const char* tempStr = ConfigMgr::instance()->text("display_11xuan5.xml",String::createWithFormat("t%d",20 +  GuangDongwanFaMap[nowPos])->getCString());
...
ssize_t GuangDong11Xuan5Layer::numberOfCellsInTableView(TableView *table)
{
	if(table->getTag() == 1000) //菜单
	{
...
void GuangDong11Xuan5Layer::scrollViewDidScroll(ScrollView* view)
{

}

void GuangDong11Xuan5Layer::scrollViewDidZoom(ScrollView* view)
{

}

void GuangDong11Xuan5Layer::transferString(string &str, int nStep)
{
	bool bTeMa = false;
	int nPos = str.find("|");
	if (nPos >= 0)
...
void GuangDong11Xuan5Layer::queryGameMoreRet(Object *obj)
{

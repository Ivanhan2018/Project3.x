...
Scene* GuangDong11Xuan5Cart::scene()
{
	Scene *scene = Scene::create();
	GuangDong11Xuan5Cart *layer = GuangDong11Xuan5Cart::create();
	scene->addChild(layer);
	return scene;
}
GuangDong11Xuan5Cart::GuangDong11Xuan5Cart()
{
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Cart::ZhuiHaoback), "ZhuiHaoback", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Cart::SetusedBonusRet), "SetusedBonusRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Cart::pressChaseNumShow), "ChaseNumBerItem", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Cart::RemoveCurrentLayer), "RemoveCurrentLayer", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(GuangDong11Xuan5Cart::RefreshData), "RefreshData", NULL);
}
GuangDong11Xuan5Cart::~GuangDong11Xuan5Cart()
{
	if(gameResultTable != nullptr)
	{
...
bool GuangDong11Xuan5Cart::init()
{
	if (!Layer::init())
	{
		return false;
...
void GuangDong11Xuan5Cart::initData()
{
...
void GuangDong11Xuan5Cart::initView()
{
	auto listener = EventListenerTouchOneByOne::create();
	listener->setSwallowTouches(true);
	listener->onTouchBegan = CC_CALLBACK_2(GuangDong11Xuan5Cart::onTouchBegan,this);
	listener->onTouchEnded = CC_CALLBACK_2(GuangDong11Xuan5Cart::onTouchEnded,this);
	listener->onTouchMoved = CC_CALLBACK_2(GuangDong11Xuan5Cart::onTouchMoved,this);
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(GuangDong11Xuan5Cart::back,this));
	...
	confirmItem = MenuItemSprite::create(confirmNormalImage,confirmSelectedImage,CC_CALLBACK_1(GuangDong11Xuan5Cart::confirm,this));
	MenuItemSprite *ZhuiHaoItem = MenuItemSprite::create(ZhuiHaoNormalImage,ZhuiHaoSelectedImage,CC_CALLBACK_1(GuangDong11Xuan5Cart::ZhuiHaoItemMinusobj,this));
	...
	fontSize = 30;
	KindTTfle = LabelTTF::create(ConfigMgr::instance()->text("display_DuangDong.xml", "t440"), "", fontSize);
	...
	MenuItemSprite *addRandomItem = MenuItemSprite::create(addRandomNormalImage,addRandomSelectedImage,CC_CALLBACK_1(GuangDong11Xuan5Cart::deleRandom,this));
	...
	ZhuiHao11Xuan5Cart = ChaseNumBerLayer::create();
...
void GuangDong11Xuan5Cart::updateBetInfo()
{
	int totalZhuShu = 0;
	float totalMoney = 0;
...
void GuangDong11Xuan5Cart::ZhuiHaoItemMinusobj(Object *obj)
{
	playButtonSound();
...
void GuangDong11Xuan5Cart::pressChaseNumShow(Object *obj)
{
	ShowIsChaseNum();
	this->setKeypadEnabled(true);
}

void GuangDong11Xuan5Cart::SetusedBonusRet(Object *obj)
{
...
void GuangDong11Xuan5Cart::ZhuiHaoback(Object *obj)
{
	back(NULL);
}

void GuangDong11Xuan5Cart::back(Object *obj)
{
	playButtonSound();
...
void GuangDong11Xuan5Cart::ShowIsChaseNum()
{
...
void GuangDong11Xuan5Cart::dissisChaseNum()
{
...
//transaction menu
void GuangDong11Xuan5Cart::confirm(Object* obj)
{
	playButtonSound();
	bool bRet = EntityMgr::instance()->getDispatch()->connectLoginServer();
	if(!bRet)
...
void GuangDong11Xuan5Cart::bottomMenuEnabled(bool GuangDong11Xuan5BoolSuccen)
{
...
void GuangDong11Xuan5Cart::deleRandom(Object* obj)
{
	playButtonSound();
...
void GuangDong11Xuan5Cart::onEnter()
{
	Layer::onEnter();

}

void GuangDong11Xuan5Cart::onExit()
{
	Layer::onExit();
}

void GuangDong11Xuan5Cart::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
cocos2d::Size GuangDong11Xuan5Cart::cellSizeForTable(TableView *table)
{
	cocos2d::Size size;
...
ssize_t GuangDong11Xuan5Cart::numberOfCellsInTableView(TableView *table)
{
	return MyBetNumber::getInstance()->size() + 1;

}
TableViewCell *GuangDong11Xuan5Cart::tableCellAtIndex(TableView *table,ssize_t index)
{
	...
	if(wanFanKind->getValue() == DaXiaoDanShuang_DW) 
	{
...
void GuangDong11Xuan5Cart::tableCellTouched(TableView *table, TableViewCell *cell)
{
...
void GuangDong11Xuan5Cart::scrollViewDidScroll(ScrollView* view)
{

}
void GuangDong11Xuan5Cart::scrollViewDidZoom(ScrollView* view)
{

}

bool GuangDong11Xuan5Cart::onTouchBegan(Touch *pTouch, Event *pEvent)
{
...
void GuangDong11Xuan5Cart::onTouchMoved(Touch *pTouch, Event *pEvent)
{

}

void GuangDong11Xuan5Cart::onTouchEnded(Touch *pTouch, Event *pEvent)
{	
	Vec2 pos = Director::getInstance()->convertToGL(pTouch->getLocationInView());
	endPoint = pos;
...
void GuangDong11Xuan5Cart::pressDeleteButton(int index)
{
	NotificationCenter::getInstance()->postNotification("DeleteItem", Integer::create(index));
}

void GuangDong11Xuan5Cart::RemoveCurrentLayer(Object *obj)
{
	this->setPositionY(2000);
	this->ShowIsChaseNum();	
}

void GuangDong11Xuan5Cart::RefreshData(Object *obj)
{

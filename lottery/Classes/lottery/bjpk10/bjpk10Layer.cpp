...
bjpk10Layer::bjpk10Layer()
{
	addRandSeedBJCarPK10();
	wKindID = NULL;
	wPeriod = NULL;
	szLotNum = NULL;
	szShijian = NULL;
	...
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::GetLastYueRet), "GetLastYueRet", NULL);  ///余额查询
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::ShiYiXuanWoNumber), "ShiYiXuanWoNumber", NULL);  ///追号所花费的金额
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::ZhuiHaoTouZhuJinENumber), "ZhuiHaoTouZhuJinENumber", NULL);  ///追号所花费的金额
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::queryGameRet), "QueryGameRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::touZhuRet), "CQSSCRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::changeKind), "CQSSCChangeKind", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::deleteItem), "DeleteItem", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::addRandomItem), "AddRandomItem", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::CartConfirm), "CartConfirm", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::clearNumbers), "ClearNumbers", NULL);
	//NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::getSystemTimeObject), "GetSystemTimeRet", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::updateTouZhuJine), "UpdateTouZhuJine", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::KindMyFanDianRet), "QueryMyFanDianRet", NULL);

	//追号验证
	NotificationCenter::getInstance()->addObserver(this,callfuncO_selector(bjpk10Layer::isFenDanHour), "IsFendanHour", NULL);

	//跨年期号处理
	NotificationCenter::getInstance()->addObserver(this,callfuncO_selector(bjpk10Layer::kuaNianExpect), "KuaNian", NULL);

	//结果查询
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10Layer::queryGameMoreRet), "QueryMoreGameRet", NULL);
}

void bjpk10Layer::getSystemTime(float dt)
{
...
bjpk10Layer::~bjpk10Layer()
{
	...
	this->unschedule(schedule_selector(bjpk10Layer::updatePeriod));
	this->unschedule(schedule_selector(bjpk10Layer::getSystemTime));
	this->unschedule(schedule_selector(bjpk10Layer::myUpdate));
...
void bjpk10Layer::updatePeriod(float dt)
{
	EntityMgr::instance()->getDispatch()->SendPacketQueryGameResult(gameKind);
}

void bjpk10Layer::refreshLayer()
{
	//更新期号
	EntityMgr::instance()->getDispatch()->SendPacketQueryGameResult(gameKind);
	//更新余额
	...
	//更新奖金
	EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC_FanDian(gameKind, BetLimit::GetWanfaIdFromId(wanFaKind,2));
...
void bjpk10Layer::setWanFaKind(PK10GameKind kind)
{
	wanFaKind = kind;
...
void bjpk10Layer::myUpdate(float dt)
{
...
void bjpk10Layer::getSystemTimeObject(Object *obj)
{
...
void bjpk10Layer::initData()
{
	wanFaKind = WF_GuanJun;
...
void bjpk10Layer::initView()
{
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(bjpk10Layer::back,this));
	...
	MenuItemSprite *setupItem = MenuItemSprite::create(setupItemNormalImage,setupItemSelectedImage,CC_CALLBACK_1(bjpk10Layer::setting,this));
	...
	//MenuItemLabel *lbItem = MenuItemLabel::create(moreItemLabel,CC_CALLBACK_1(bjpk10Layer::jumpResult,this));
	...
	MenuItemSprite *deleteItem = MenuItemSprite::create(deleteNormalImage,deleteSelectedImage,CC_CALLBACK_1(bjpk10Layer::toDelete,this));
	MenuItemSprite *randomGambleItem = MenuItemSprite::create(randomNormalImage,randomSelectedImage,CC_CALLBACK_1(bjpk10Layer::toRandomGamble,this));
	...
	moreItem = MenuItemSprite::create(moreNormalImage2,moreSelectedImage2,CC_CALLBACK_1(bjpk10Layer::toMore,this));
	...
	MenuItemSprite *beiAddItem = MenuItemSprite::create(beiAdd,beiAddPress,CC_CALLBACK_1(bjpk10Layer::beiAdd,this));
	MenuItemSprite *beiMinusItem = MenuItemSprite::create(beiMinus,beiMinusPress,CC_CALLBACK_1(bjpk10Layer::beiMinus,this));
	...
	MenuItemSprite *FanDianSelectedImage = MenuItemSprite::create(FanDianSprite_1,FanDianSprite_2,CC_CALLBACK_1(bjpk10Layer::FanDianMinus,this));
	...
	cartItem = MenuItemSprite::create(cartNormalImage,cartSelectedImage,CC_CALLBACK_1(bjpk10Layer::toGamble,this));
	MenuItemSprite *confirmItem = MenuItemSprite::create(confirmNormalImage,confirmSelectedImage,CC_CALLBACK_1(bjpk10Layer::toCart,this));
	...
	YuanSelectedImageLayer = MenuItemSprite::create(YuanSprite_1,YuanSprite_2,YuanSprite_3,CC_CALLBACK_1(bjpk10Layer::XuanZeMonenyLayer,this));
	YuanSelectedImageLayer->setTag(YuanShiShiCAITag);
	JiaoSelectedImageLayer = MenuItemSprite::create(JiaoSprite_1,JiaoSprite_2,JiaoSprite_3,CC_CALLBACK_1(bjpk10Layer::XuanZeMonenyLayer,this));
	JiaoSelectedImageLayer->setTag(JiaoShiShiCAITag);
	FenSelectedImageLayer = MenuItemSprite::create(FenSprite_1,FenSprite_2,FenSprite_3,CC_CALLBACK_1(bjpk10Layer::XuanZeMonenyLayer,this));
	FenSelectedImageLayer->setTag(FenShiShiCAITag);
	//新增厘模式
	LiSelectedImageLayer = MenuItemSprite::create(LiSprite_1, LiSprite_2, LiSprite_3,CC_CALLBACK_1(bjpk10Layer::XuanZeMonenyLayer, this));
	...
	refreshListener->onTouchEnded = [=](Touch *pTouch, Event *pEvent){
		...
		{		
			//下拉刷新图标
			if(m_bIsOpenList && listTable->getContentOffset().y < -300)
			{
				isRun = true;
...
void bjpk10Layer::queryGameRet(Object *obj)
{
	...
	for (int i = 0; i < count; i += 4){
		...
		if (id->getValue() == gameKind){
			...
			szLotNum->retain();
			szShijian->retain();
			if (id->getValue() == CZ_BJPK10)
			{
				memset(CBJPK10Rule::m_lastExpect, 0, KJ_QIHAO_LENGTH);
				memset(CBJPK10Rule::m_lastKjShj, 0, KJ_SHIJIAN_LENGTH);
				memcpy(CBJPK10Rule::m_lastExpect, mPeriod->getCString(), strlen(mPeriod->getCString()));
				memcpy(CBJPK10Rule::m_lastKjShj, szShijian->getCString(), strlen(szShijian->getCString()));
			}
			//this->updateLotteryId();
			//this->updateCurrentTime();
			break;
...
void bjpk10Layer::updateLotteryId()
{
...
void bjpk10Layer::updateCurrentTime()
{
	String *headStr = NULL;
...
void bjpk10Layer::touZhuRet(Object *obj)
{
...
//top menu
void bjpk10Layer::setting(Object* obj)
{
	playButtonSound();
...
//middle menu
void bjpk10Layer::toMore(Object* obj)
{
	playButtonSound();
...
void bjpk10Layer::jumpResult(Object* obj)
{	
	playButtonSound();	
...
void bjpk10Layer::XuanZeMonenyLayer(Object *obj)
{
	//playButtonSound();
...
void bjpk10Layer::toRandomGamble(Object* obj)
{
	playButtonSound();
...
void bjpk10Layer::ZhuiHaoTouZhuJinENumber(Object *obj)
{
...
void bjpk10Layer::ShiYiXuanWoNumber(Object *obj)
{
...
//bottom menu
void bjpk10Layer::toDelete(Object* obj)
{
	playButtonSound();
...
void bjpk10Layer::toCart(Object* obj)
{
	playButtonSound();
	...
	if(!bRet)
	{
		...
		Integer* b_wanFaKind = Integer::create(BetLimit::GetWanfaIdFromId(wanFaKind,2));
...
void bjpk10Layer::toGamble(Object* obj)
{
	playButtonSound();
	...
	if(!bRet)
	{
		...
		//判断注数限制
		int maxCount = BetLimit::GetMaxBetFromId(gameKind,BetLimit::GetWanfaIdFromId(wanFaKind,2));
		int nowTouzhu = betZhuShu;
		if(maxCount < nowTouzhu)
		{
			std::string strDisplay =
				BetLimit::GetWanFaNameFromId(gameKind,BetLimit::GetWanfaIdFromId(wanFaKind,2)) +
		...
		EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC(qishuStr, gameKind, BetLimit::GetWanfaIdFromId(wanFaKind, 2),
...
void bjpk10Layer::changeKind(Object *obj)
{
	selectedItemTag = ((Integer *)obj)->getValue(); 
	//保存
	MyBetData::getInstance()->setLastWanfaId(PK10WanfaMap[selectedItemTag]);
	//
	...
	this->setWanFaKind(PK10WanfaMap[selectedItemTag]);
	betArea->clearNumbers();
	betArea->cancelAllMenuSelect();
	betZhuShuTouZhuJinE = 0;
...
void bjpk10Layer::onEnter()
{
	BaseLayer::onEnter();
}

void bjpk10Layer::onExit()
{
	BaseLayer::onExit();
}

void bjpk10Layer::back(Object *obj)
{
	playButtonSound();
...
void bjpk10Layer::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
void bjpk10Layer::showKindView()
{
	...
	//彩种下拉框选择
	kindLayer = bjpk10KindScrollView::create();
...
void bjpk10Layer::isCartShow()
{
	MonenyMenuLayer->setEnabled(true);
}
void bjpk10Layer::isCartdiss()
{
	MonenyMenuLayer->setEnabled(false);
}
void bjpk10Layer::isCartShowLayer(Object *obj)
{
	this->isCartShow();
}

void bjpk10Layer::deleteItem(Object *obj)
{
...
void bjpk10Layer::addRandomItem(Object *obj)
{
	this->setKeypadEnabled(true);
	betZhuShuTouZhuJinE = 0;
	beilvInput->setText("1");
...
void bjpk10Layer::CartConfirm(Object *obj)
{
...
void bjpk10Layer::clearNumbers(Object *obj)
{
	 MyBetNumber::getInstance()->clear();
...
void bjpk10Layer::setGameKind(CaiZhong kind)
{
	//初始化数据
	MyBetData::getInstance()->setCurCaiZhongId(kind);

	int last = MyBetData::getInstance()->getLastWanfaId();
	if(last == -1) last = PK10WanfaMap[1];

	this->setWanFaKind((PK10GameKind)last);
	selectedItemTag = 1;

	for(int i = 0;i < MyBetData::getInstance()->getWanfaSize();i ++)
	{
		if(PK10WanfaMap[MyBetData::getInstance()->getWanfaAt(i)] == last)
		{
	...
	this->schedule(schedule_selector(bjpk10Layer::updatePeriod), 3);

	//跨年处理
#if 1
	EntityMgr::instance()->getDispatch()->SendPacketWithGetKuaNianQiHao(gameKind);
	this->schedule(schedule_selector(bjpk10Layer::getSystemTime), 3);	
#endif
	this->schedule(schedule_selector(bjpk10Layer::myUpdate), 1);
...
void bjpk10Layer::updateTouZhuJine(Object *obj)
{
	betArea->getBetNumber();
	betZhuShuTouZhuJinE = betArea->getBetZhuShu();
...
void bjpk10Layer::GetLastYueRet(Object *obj)
{
...
//------------------------------------------------新增----------------------------------------------------------------
void bjpk10Layer::editBoxEditingDidEnd(EditBox* editBox)
{
...
void bjpk10Layer::FanDianMinus(Object *obj)
{
	playButtonSound();
	...
	listener->onTouchBegan = CC_CALLBACK_2(bjpk10Layer::onTouchBegan,this);
	listener->onTouchEnded = CC_CALLBACK_2(bjpk10Layer::onTouchEnded,this);
	listener->onTouchMoved = CC_CALLBACK_2(bjpk10Layer::onTouchMoved,this);
	...
	MenuItemSprite* MakeSureMenuItem = MenuItemSprite::create(MakeSureSprite_1,MakeSureSprite_2,CC_CALLBACK_1(bjpk10Layer::SuccenGameResume,this));
	MenuItemSprite* PCloseItemMenuItem = MenuItemSprite::create(PCloseItem_1,PCloseItem_2,CC_CALLBACK_1(bjpk10Layer::pCoseGameResume,this));
	...
	MenuItemSprite* MinusMenuItem = MenuItemSprite::create(MinusValueSprite_1,MinusValueSprite_2,CC_CALLBACK_1(bjpk10Layer::PlusFianDian,this));
	MinusMenuItem->setAnchorPoint(Vec2(0.5,0.5));
	MinusMenuItem->setPosition(Vec2(winSize.width*0.84 + 10,winSize.height*0.5 + tempInt));
	MenuItemSprite* PlusMenuItem = MenuItemSprite::create(PlusValueSprite_1,PlusValueSprite_2,CC_CALLBACK_1(bjpk10Layer::MinusFanDian,this));
...
void bjpk10Layer::PlusFianDian(Object *obj)
{
...
void bjpk10Layer::MinusFanDian(Object *obj)
{
	float PlusFanDianvalie =PlusFanDianvalieMAX;
...
void bjpk10Layer::pCoseGameResume(Object *obj)
{
...
void bjpk10Layer::SuccenGameResume(Object *obj)
{
	this->removeChild(layerColor, true);
	char str[33];
	char str2[33];
	...
	if(!bRet)
	{
		...
		EntityMgr::instance()->getDispatch()->SendPacketWithGetTouZhuSetUserBonus(gameKind, BetLimit::GetWanfaIdFromId(wanFaKind,2), PlusFanDianvalieMAX, BaiFenbiNumber);
	}
}

/**触摸开始*/
bool bjpk10Layer::onTouchBegan(Touch *pTouch, Event *pEvent)
{	
...
void bjpk10Layer::onTouchMoved(Touch *pTouch, Event *pEvent)
{

}

void bjpk10Layer::onTouchEnded(Touch *pTouch, Event *pEvent)
{	

}

void bjpk10Layer::KindMyFanDianRet(Object *obj)
{
	...
	int count = data->count();
	if (count == 0) return;
	int myWanFa = BetLimit::GetWanfaIdFromId(wanFaKind,2);
	for (int i = 0;i < count; i += 4)
	{
		Integer *id = (Integer*) data->objectAtIndex(i);
...
void bjpk10Layer::pressMinus(Object *obj)
{
...
void bjpk10Layer::beiAdd(Object *obj)
{
	playButtonSound();
...
void bjpk10Layer::beiMinus(Object *obj)
{
	playButtonSound();
...
void bjpk10Layer::updateMoneyLabel()
{
...
void bjpk10Layer::tableCellTouched(TableView* table, TableViewCell* cell)
{
...
cocos2d::Size bjpk10Layer::cellSizeForTable(TableView *table)
{
	cocos2d::Size result;
...
TableViewCell* bjpk10Layer::tableCellAtIndex(TableView *table, ssize_t idx)
{
	...
	if(table->getTag() == 1000) //菜单
	{
		...
		const char* tempStr = ConfigMgr::instance()->text("display_pk10.xml",String::createWithFormat("t%d",20 +  PK10WanfaMap[nowPos])->getCString());
...
ssize_t bjpk10Layer::numberOfCellsInTableView(TableView *table)
{
	if(table->getTag() == 1000) //菜单
	{
...
void bjpk10Layer::scrollViewDidScroll(ScrollView* view)
{

}

void bjpk10Layer::scrollViewDidZoom(ScrollView* view)
{

}

void bjpk10Layer::transferString(string &str, int nStep)
{
	bool bTeMa = false;
	int nPos = str.find("|");
	if (nPos >= 0)
...
void bjpk10Layer::queryGameMoreRet(Object *obj)
{

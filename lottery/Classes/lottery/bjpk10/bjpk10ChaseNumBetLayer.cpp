#include "bjpk10ChaseNumBetLayer.h"
#include "RoomLayer.h"
#include "ConfigMgr.h"
...
Scene* bjpk10ChaseNumBetLayer::scene()
{
	Scene *scene = Scene::create();
	bjpk10ChaseNumBetLayer *layer = bjpk10ChaseNumBetLayer::create();
	scene->addChild(layer);
	return scene;
}

bjpk10ChaseNumBetLayer::bjpk10ChaseNumBetLayer()
{
	fandianStatus = 0;
	ZhuiHaoBool =0;
	BeiTouBool = 0;
	...
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10ChaseNumBetLayer::TouZhuZhuiHaoButton), "TouZhuChaseNumBer", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10ChaseNumBetLayer::changeKind), "GDselectedItemTagNumberCartFailed", NULL);
	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10ChaseNumBetLayer::touZhuContinueRet), "CQSSCRetZhuiHao", NULL);

	NotificationCenter::getInstance()->addObserver(this, callfuncO_selector(bjpk10ChaseNumBetLayer::IsFendanHourRet), "IsFendanHourRet", NULL);
}
bjpk10ChaseNumBetLayer::~bjpk10ChaseNumBetLayer()
{
...
bool bjpk10ChaseNumBetLayer::init()
{
	if (!Layer::init())
	{
		return false;
...
void bjpk10ChaseNumBetLayer::initData()
{
	winSize = Director::getInstance()->getWinSize();
}

void bjpk10ChaseNumBetLayer::initView()
{
	...
	MenuItemSprite *pCloseItemSprite = MenuItemSprite::create
		(pCloseNormalButton,pCloseSelectButton,CC_CALLBACK_1(bjpk10ChaseNumBetLayer::back,this));
	...
	char szBuf[100] = {0};  
	sprintf(szBuf, "%0.3f ",TouZhuJinENumber);
	...
	ButtonCodeRecordItem = MenuItemSprite::create(ButtonCodedImage,ButtonCodeNormalImage,CC_CALLBACK_1(bjpk10ChaseNumBetLayer::XuanZeZhuiHaoQiShu,this));
	Menu *ButtonCodeMenu = Menu::create(ButtonCodeRecordItem,NULL);
	ButtonCodeMenu->setPosition(Vec2(winSize.width*0.45-22,winSize.height*0.83));	
	...
	betRecordItem = MenuItemSprite::create(winningRecordSelectedImage,contiRecordNormalImage,CC_CALLBACK_1(bjpk10ChaseNumBetLayer::IsEndeBeiTou,this));
	...
	GetRecordItem = MenuItemSprite::create(betRecordNormalImage,betRecordSelectedImage,CC_CALLBACK_1(bjpk10ChaseNumBetLayer::IsEndeZhuiHao,this));
	...
	StramItem = MenuItemSprite::create(StramNormalImage_1,StramNormalImage_2,CC_CALLBACK_1(bjpk10ChaseNumBetLayer::betRecord,this));
	CloseItem = MenuItemSprite::create(CloseNormalImage_1,CloseNormalImage_2,CC_CALLBACK_1(bjpk10ChaseNumBetLayer::ZhuiHaoCloseButton,this));
...
//top menu
void bjpk10ChaseNumBetLayer::setting(Object* obj)
{
	playButtonSound();
...
void bjpk10ChaseNumBetLayer::back(Object *obj)
{
	playButtonSound();
...
//transaction menu
void bjpk10ChaseNumBetLayer::recharge(Object* obj)
{

}

void bjpk10ChaseNumBetLayer::withdraw(Object *obj)
{

}
void bjpk10ChaseNumBetLayer::ZhuiHaoCloseButton(Object *obj)
{
	playButtonSound();
...
//record menu
void bjpk10ChaseNumBetLayer::changeKind(Object *obj)
{
...
void bjpk10ChaseNumBetLayer::ShowZhuiHaoMen()
{
...
void bjpk10ChaseNumBetLayer::dissZhuiHaoMen()
{
...
void bjpk10ChaseNumBetLayer::TouZhuZhuiHaoButton(Object *obj)
{
	...
	char szBuf2[100] = {0};  
	sprintf(szBuf2, "%0.3f ",ZhangHuYuENumber);
	String *TouZhuYuEString = String::createWithFormat("%s %s%s",
		ConfigMgr::instance()->text("display_DuangDong.xml", "t3"),szBuf2,
		ConfigMgr::instance()->text("display_DuangDong.xml", "t2"));	
...
void bjpk10ChaseNumBetLayer::betRecord(Object *obj)
{
	playButtonSound();
...
void bjpk10ChaseNumBetLayer::IsFendanHourRet(Object *obj)
{
	...
	for(int id = 0;id < MyBetNumber::getInstance()->size();id ++)
	{
		...
		EntityMgr::instance()->getDispatch()->SendPacketWithTouZhuCQSSC_ZhioHao(zhuiHaoQiShu, qiShu, tempInfo.m_gameKind->getValue(), BetLimit::GetWanfaIdFromId(tempInfo.m_wanFaKind->getValue(),2),
...
void bjpk10ChaseNumBetLayer::touZhuContinueRet(Object *obj)
{
...
void bjpk10ChaseNumBetLayer::ZhuiHaoQiShuRecord(Object *obj)
{
}

void bjpk10ChaseNumBetLayer::contiRecord(Object *obj)
{
}

void bjpk10ChaseNumBetLayer::onEnter()
{
	Layer::onEnter();
}

void bjpk10ChaseNumBetLayer::onExit()
{
	Layer::onExit();
}

void bjpk10ChaseNumBetLayer::onKeyReleased(EventKeyboard::KeyCode keycode, Event *event)
{
...
cocos2d::Size bjpk10ChaseNumBetLayer::cellSizeForTable(TableView *table)
{
	cocos2d::Size size;
...
ssize_t bjpk10ChaseNumBetLayer::numberOfCellsInTableView(TableView *table)
{
	int tag = dynamic_cast<Node*>(table)->getTag();
...
TableViewCell *bjpk10ChaseNumBetLayer::tableCellAtIndex(TableView *table,ssize_t index)
{
	...
	if(tag == 1111){
		...
		XuanZeQiShuItem = MenuItemSprite::create(XuanZeQiShuNormalImage,XuanZeQiShuSelectedImage,CC_CALLBACK_1(bjpk10ChaseNumBetLayer::XuanZeQiShu,this));
...
void bjpk10ChaseNumBetLayer::tableCellTouched(TableView *table, TableViewCell *cell)
{
...
void bjpk10ChaseNumBetLayer::scrollViewDidScroll(ScrollView* view)
{

}
void bjpk10ChaseNumBetLayer::scrollViewDidZoom(ScrollView* view)
{

}
void bjpk10ChaseNumBetLayer::XuanZeQiShu(Object *obj)
{
...
void bjpk10ChaseNumBetLayer::XuanZeZhuiHaoQiShu(Object *obj)
{
	playButtonSound();
...
void bjpk10ChaseNumBetLayer::IsEndeBeiTou(Object *obj)
{
	playButtonSound();
...
void bjpk10ChaseNumBetLayer::IsEndeZhuiHao(Object *obj)
{
	playButtonSound();
...
void bjpk10ChaseNumBetLayer::editBoxEditingDidEnd(EditBox* editBox)
{
	string nMoshiString = CtratebeilvInput->getText();
	int nBeiShu = atoi(nMoshiString.c_str());

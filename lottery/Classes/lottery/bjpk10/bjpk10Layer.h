#ifndef _bjpk10Layer_H_
#define _bjpk10Layer_H_
...
class bjpk10Layer : public BaseLayer, public EditBoxDelegate,public TableViewDelegate,
	public TableViewDataSource
{
public:
    bjpk10Layer();
    ~bjpk10Layer();
    CREATE_FUNC(bjpk10Layer);
    virtual bool init();
    static Scene* scene();
	...
	void refreshLayer();
private:
	void setWanFaKind(PK10GameKind kind);
	void initData();
	void initView();	
	...
	//截止时间	
	bjpk10BetArea *betArea;	
	PK10GameKind wanFaKind;
	bjpk10KindScrollView *kindLayer;
	bjpk10Cart *cart;

	bool m_bbjpk10CartSucced;  //成功有返回结果ture
	bool bjpk10BetAreaIsShow;

#ifndef _bjpk10ChaseNumBetLayer_H
#define _bjpk10ChaseNumBetLayer_H
...
//};
class bjpk10ChaseNumBetLayer : public Layer, public TableViewDelegate,
	public TableViewDataSource, public EditBoxDelegate
{
public:
	bjpk10ChaseNumBetLayer();
	~bjpk10ChaseNumBetLayer();
	CREATE_FUNC(bjpk10ChaseNumBetLayer);
	virtual bool init();
	static Scene* scene();

...
//	spt->setOpacity(0);
//	spt->runAction(Sequence::create(DelayTime::create(delTime),FadeIn::create(0.2f),NULL));
//	sptBack->setOpacity(0);
//	sptBack->runAction(Sequence::create(DelayTime::create(delTime),FadeIn::create(0.2f),CCJumpBy::create(0.6f,ccp(0.0f,0.0f),5.0f,1),
//		FadeOut::create(0.2f),CallFuncN::create(this,callfuncN_selector(ViewMenuLayer::removeSelfCall)),NULL));

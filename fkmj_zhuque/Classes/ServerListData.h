...
public:
	...
	//比赛房间
	virtual bool IsMatchRoom() { return false;}//(m_GameServer.wServerType&GAME_GENRE_MATCH)!=0; }
	//私人房间
	virtual bool IsPrivateRoom() { return false;}//(m_GameServer.wServerType&GAME_GENRE_EDUCATE)!=0; }
};

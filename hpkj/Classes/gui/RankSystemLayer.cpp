...
{
	richRankText = pConfigMgr->text("t578");
	...
	float textWidth = 200;
	myRankLabel1 = LabelTTF::create(pConfigMgr->text("t560"),"",30,cocos2d::Size(textWidth,0),kCCTextAlignmentRight);
	...
	float value = 21;
	myRankFieldLabel1 = LabelTTF::create(pConfigMgr->text("t561"),"",30,cocos2d::Size(textWidth,0),kCCTextAlignmentCenter);
	...
	myRankFieldLabel2 = LabelTTF::create(pConfigMgr->text("t562"),"",30,cocos2d::Size(textWidth,0),kCCTextAlignmentCenter);
	...
	myRankFieldLabel3 = LabelTTF::create(pConfigMgr->text("t563"),"",30,cocos2d::Size(textWidth,0),kCCTextAlignmentCenter);
...
//	this->addChild(myRankFieldLabel3, 1);
	...
	myRankFieldLabel4 = LabelTTF::create(pConfigMgr->text("t564"),"",30,cocos2d::Size(textWidth,0),kCCTextAlignmentCenter);
...
void RankSystemLayer::doSomething()
{
	...
	if(currentItem == TabLayerBaseTag){
		myRankFieldLabel4->setString(pConfigMgr->text("t564"));
		...
		myRankFieldLabel4->setString(pConfigMgr->text("t565"));
		...
		myRankFieldLabel4->setString(pConfigMgr->text("t566"));
		richTable->setVisible(false);
		heroTable->setVisible(false);
		...
		myRankFieldLabel4->setString(pConfigMgr->text("t567"));
		richTable->setVisible(false);
		heroTable->setVisible(false);
		luckTable->setVisible(false);
		...
		myRankFieldLabel4->setString(pConfigMgr->text("t568"));
		richTable->setVisible(false);
		heroTable->setVisible(false);
		luckTable->setVisible(false);
		teacherTable->setVisible(false);
...
{  
	...
	if(rankText == "")
	{
		father->setMyRankText(pConfigMgr->text("t578"), tableTag);
	}
	else
	{
...
TableViewCell *RankTableHelper::tableCellAtIndex(TableView *table,ssize_t index)
{
	...
	if(index > field4ValueArray->count()){
		...
		chengHaoLabel = LabelTTF::create(pConfigMgr->text("t10"),"",30,cocos2d::Size(textWidth,0),kCCTextAlignmentCenter);
	}

...
// 		LabelTTF *str1 = LabelTTF::create(pConfigMgr->text("t214"),"",18,cocos2d::Size(750,300),kCCTextAlignmentLeft);
...
// 		m_node->addChild(str1,3);
		...
		for (int i=0;i<32;i++)
		{
			...
			Rect rect=addString(pt,pConfigMgr->text(str),cocos2d::Size(0,0));

...
bool RechargeLayer::init()
{
	...
	do 
	{
		...
		/**添加文字提示**/
		//LabelTTF *pTextWaring0 =LabelTTF::create(pConfigMgr->text("t156"),"HelveticaNeue-Bold",18);
		//pTextWaring0->setPosition(Vec2(winSize.width*0.5,winSize.height*0.683));
		//this->addChild(pTextWaring0,3);

		//LabelTTF *pTextWaring1 =LabelTTF::create(pConfigMgr->text("t157"),"HelveticaNeue-Bold",18);

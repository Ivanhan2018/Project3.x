...
//	this->addChild(mianfeiMenu);
    ...
    LabelTTF* loginPassLabel = LabelTTF::create(pConfigMgr->text("t1030"),"",24);
    LabelTTF* bankPassLabel = LabelTTF::create(pConfigMgr->text("t1031"),"",24);
   ...
   this->addChild(bankPassLabel);
	//tips
	LabelTTF* tipsLabel0 = LabelTTF::create(pConfigMgr->text("t158"),"",24);
	LabelTTF* tipsLabel1 = LabelTTF::create(pConfigMgr->text("t159"),"",24);
	LabelTTF* tipsLabel2 = LabelTTF::create(pConfigMgr->text("t160"),"",24);
   ...
   this->addChild(tipsLabel2);
    ...
    LabelTTF* tipsLabel3 = LabelTTF::create(pConfigMgr->text("t1032"),"",20);
   ...
   this->addChild(tipsLabel3);
    ...
    orginPasswordInput->setPlaceHolder(pConfigMgr->text("t4"));
    modifyPasswordInput->setPlaceHolder(pConfigMgr->text("t4"));
	surePasswordInput->setPlaceHolder(pConfigMgr->text("t4"));
...
void ModifyPassWord::clickButton(Object* obj)
{
	...
	{
		//���뺬�зǷ��ַ�
		MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(pConfigMgr->text("t457"),Vec2(427,240));
	...
	if(bRet)
	{
		pMsgDispatch->modifyPassWord(szOldPassword,szNewPassword, isLoginPass);
	}
}
...
void ModifyPassWord::onChangePassWordResult(Object* obj)
{
	...
	if(i == 0)
	{
		...
		MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(pConfigMgr->text("t167"),Vec2(427,240));
		this->addChild(layer);
	...
	{
		MovingLabelLayer* layer = MovingLabelLayer::MovingLabelLayerWith(pConfigMgr->text("t168"),Vec2(427,240));
		this->addChild(layer);
		//ʧ��
	}
}

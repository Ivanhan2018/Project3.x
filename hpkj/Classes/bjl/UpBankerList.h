#ifndef		__UP_BANKER_LIST__
#define		__UP_BANKER_LIST__
#include "cocos2d.h"
#include "cocos-ext.h"
#include "define.h"
#include <limits>
...
class UpBankerList:public Layer,public TableViewDataSource, public TableViewDelegate
{
public:
	CREATE_FUNC(UpBankerList);
	virtual bool init();

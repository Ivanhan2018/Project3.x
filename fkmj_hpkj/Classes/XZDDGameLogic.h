...
namespace XZDD
{
	...
	*/
	...
	public:
		...
		//杠牌分析
		BYTE AnalyseGangCard(const BYTE cbCardIndex[MAX_INDEX], const XZDD_CMD_WeaveItem WeaveItem[], BYTE cbWeaveCount, tagGangCardResult & GangCardResult);
		//转换函数
	public:
		//扑克转换
	...
	public:
		...
		void GetCardInfoList(BYTE* pHandCardData, int nHandCardCount,std::vector<XZDD_Card_Info>& kCardInfoList);
	};
}

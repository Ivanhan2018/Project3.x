...
#define WIK_CS_GANG				0x20//长沙杠							//吃牌类型
...
#define CHR_DA_PENG_DUI					0x00000008									//大碰对
#define CHR_QI_XIAO_DUI					0x00000010									//七小对
#define CHR_QING_YI_SE					0x00000020									//清一色
#define CHR_LONG_QI_DUI					0x00000040									//龙七对
#define CHR_MEN_QING_YI_SE				0x00000080									//门清清一色
#define CHR_MEN_QING_DA_PENG_DUI		0x00000100									//门清大碰对
#define CHR_QING_YI_DA_PENG_DUI			0x00000200									//清一色大碰对
#define CHR_FENG_YI_SE					0x00000400									//风一色
#define CHR_SHI_SAN_YAO					0x00000800									//十三幺
#define CHR_SHI_BA_LUO_HAN				0x00001000									//十八罗汉

#define CHR_GANG_KAI				0x00002000									//杠上开花
#define CHR_QIANG_GANG_HU			0x00004000									//抢杠胡
#define CHR_GANG_SHANG_PAO			0x00008000									//杠上炮
#define CHR_MEN_QING_DA_PENG_DUI_QING_YI_SE				0x00010000									//清一色大碰对门清
#define CHR_DIAN_GANG									0x00020000									//点杠


#define CHR_ZI_MO					0x01000000									//自摸
#define CHR_FANGPAO				0x02000000									//放炮 
#define CHR_JIEPAO				0x04000000									//接炮
//扑克定义
...
//	typedef CWHArray<tagAnalyseItem,tagAnalyseItem &> CAnalyseItemArray;
	...
	public:
		...
		void getTingCardSY(const BYTE cbCardIndex[MAX_INDEX],const CMD_WeaveItem WeaveItem[], BYTE cbWeaveCount,std::vector<BYTE>& kTingCardList);

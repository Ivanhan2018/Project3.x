...
void NCMJGameScence::initSetButton()
{
	if (WidgetFun::getChildWidget(this,"GameSetPlane") == NULL)
	{
		return;
	}
	WidgetManager::addButtonCB("SetBarSider1",this,button_selector(NCMJGameScence::SetBarSider1));
	WidgetManager::addButtonCB("SetBarSider2",this,button_selector(NCMJGameScence::SetBarSider2));
	WidgetManager::addButtonCB("NCMJ_Button_GameSet",this,button_selector(NCMJGameScence::Button_GameSet));
	WidgetManager::addButtonCB("NCMJ_Button_HideSet",this,button_selector(NCMJGameScence::Button_HideSet));
...
void NCMJGameScence::SetBarSider1(cocos2d::Ref* pNode,WidgetUserInfo*)
{
...
void NCMJGameScence::SetBarSider2(cocos2d::Ref* pNode,WidgetUserInfo* pUserInfo)
{
	cocos2d::SliderMenu* pSlider = WidgetFun::castNode<cocos2d::SliderMenu>((Node*)pNode);
...
void NCMJGameScence::Button_HideSet(cocos2d::Ref* pNode,WidgetUserInfo*)
{
...
void NCMJGameScence::Button_GameSet(cocos2d::Ref* pNode,WidgetUserInfo* pUserInfo)
{
